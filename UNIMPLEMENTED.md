...
| UNIMPL-004 | Secondary List Filters | Migration of secondary filter dropdowns to `MudToggleGroup` | E.1 | Segmented controls on multi-facet list pages require UX review on mobile viewports (< 360px). | Deferred to mobile responsive audit phase. |
