...
PAGES_TO_TEST = [
    ...
    {"name": "Financial Years & Quarters List", "url": "/admin/financial-years"},
    {"name": "Create Financial Year Form", "url": "/admin/financial-years/create"},
    {"name": "Financial Year Detail View", "url": "/admin/financial-years/1"},
