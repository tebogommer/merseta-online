...
def test_pdf_endpoints_and_notifications():
    ...
    # 1. Direct PDF Generation API Endpoint Verification
    ...
    for path, desc in endpoints:
        ...
        try:
            ...
            print(f"  [FAIL] {desc} ({path}): {ex}")
            raise ex

    # 2. Browser E2E UI Verification
    print("\n--- 2. Testing Browser UI Integration & SignalR Matrix ---")
    with sync_playwright() as p:
        ...
        page.wait_for_selector("text=MerSETA NSDMS Executive Operations Portal", timeout=10000)
