...
public class SETMISFile400BeanVersionTwo  implements IDataEntity {
	...
	@CSVAnnotation(length = 4, className = Date.class, datePattern = DataExtractService.QCTO_DATE_FORMAT_ONLY_YEAR)
