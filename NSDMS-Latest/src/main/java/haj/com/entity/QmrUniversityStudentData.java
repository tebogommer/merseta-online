...
/**
 * QmrUniversityStudentData.
 *
 * @author Techfinium
 */
@Entity
@Table(name = "qmr_university_student_data")
@AuditTable(value = "qmr_university_student_data_hist")
@Audited
public class QmrUniversityStudentData implements IDataEntity {

	/** The Constant serialVersionUID. */
	private static final long serialVersionUID = 1L;

	/** Unique Id of QmrUniversityStudentData. */
	@Id
	...
	@Column(name = "name_of_Instetution") /*name of college*/
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		QmrUniversityStudentData other = (QmrUniversityStudentData) obj;
		if (id == null) {
			if (other.id != null)
				return false;
	...
	/*
	 * Index:
	 * CREATE INDEX IDX_DR_qmr_university_student_data ON merseta.qmr_university_student_data (qmr_fin_years_id, qmr_entered_completed);
	 */
