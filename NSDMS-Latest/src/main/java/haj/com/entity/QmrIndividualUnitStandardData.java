...
/**
 * QmrIndividualUnitStandardData.
 *
 * @author Techfinium
 */
@Entity
@Table(name = "qmr_individual_unit_standard_data")
@AuditTable(value = "qmr_individual_unit_standard_data_hist")
@Audited
public class QmrIndividualUnitStandardData implements IDataEntity {

	/** The Constant serialVersionUID. */
	private static final long serialVersionUID = 1L;

	/** Unique Id of QmrIndividualUnitStandardData. */
	@Id
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		QmrIndividualUnitStandardData other = (QmrIndividualUnitStandardData) obj;
		if (id == null) {
			if (other.id != null)
				return false;
	...
	/*
	 * Index:
	 * CREATE INDEX IDX_DR_qmr_individual_unit_standard_data ON merseta.qmr_individual_unit_standard_data (qmr_fin_years_id, qmr_entered_completed);
	 */
