...
/**
 * QmrCandidacyProgrammeData.
 *
 * @author Techfinium
 */
@Entity
@Table(name = "qmr_candidacy_programme_data")
@AuditTable(value = "qmr_candidacy_programme_data_hist")
@Audited
public class QmrCandidacyProgrammeData implements IDataEntity {

	/** The Constant serialVersionUID. */
	private static final long serialVersionUID = 1L;

	/** Unique Id of QmrCandidacyProgrammeData. */
	@Id
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		QmrCandidacyProgrammeData other = (QmrCandidacyProgrammeData) obj;
		if (id == null) {
			if (other.id != null)
				return false;
	...
	/*
	 * Index:
	 * CREATE INDEX IDX_DR_qmr_candidacy_programme_data ON merseta.qmr_candidacy_programme_data (qmr_fin_years_id, qmr_entered_completed);
	 */
