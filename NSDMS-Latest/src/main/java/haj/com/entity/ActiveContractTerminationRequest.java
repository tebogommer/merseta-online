...
@Entity
@Table(name = "active_contract_termination_request")
@AuditTable(value = "active_contract_termination_request_hist")
@Audited
public class ActiveContractTerminationRequest implements IDataEntity{
	...
	@Temporal(TemporalType.TIMESTAMP)
	@Column(name = "date_requested", length = 19)
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ActiveContractTerminationRequest other = (ActiveContractTerminationRequest) obj;
		if (id == null) {
			if (other.id != null)
				return false;
	...
	public ActiveContractTerminationRequest() {
		super();
	}

	public ActiveContractTerminationRequest(ActiveContracts activeContracts, Users requestUser, Date dateRequested, ApprovalEnum status, Boolean systemGenerated) {
		super();
	...
	public ActiveContractTerminationRequest(ActiveContracts activeContracts, Date dateRequested, ApprovalEnum status, Boolean systemGenerated) {
		super();
		this.activeContracts = activeContracts;
		this.dateRequested = dateRequested;
		this.status = status;
