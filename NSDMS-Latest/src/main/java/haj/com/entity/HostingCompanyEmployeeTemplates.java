...
@Entity
@Table(name = "hosting_company_employee_templates")
public class HostingCompanyEmployeeTemplates implements IDataEntity, Cloneable {
    ...
    private HostingCompanyEmployeeTemplates parentTemplate;
    ...
    private HostingCompanyEmployeeTemplates originalTemplate;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		HostingCompanyEmployeeTemplates other = (HostingCompanyEmployeeTemplates) obj;
		if (id == null) {
			if (other.id != null)
				return false;
	 ...
	 */
	public HostingCompanyEmployeeTemplates getParentTemplate() {
	 ...
	 */
	public void setParentTemplate(HostingCompanyEmployeeTemplates parentTemplate) {
	 ...
	 */
	public boolean hsCompareTo(HostingCompanyEmployeeTemplates o) {
		boolean equal = false;
	 ...
	 * @return true, if successful
	 */
	public boolean hsCompareToOld(HostingCompanyEmployeeTemplates o) {
		boolean equal = false;
	 ...
	 */
	public HostingCompanyEmployeeTemplates getOriginalTemplate() {
	 ...
	 */
	public void setOriginalTemplate(HostingCompanyEmployeeTemplates originalTemplate) {
