...
import haj.com.entity.enums.UnitStandardLinkTypeEnum;
...
public class SaqaUsQualification  implements IDataEntity {
     ...
     private SaqaQualification saqaQualification;
     ...
     /** The type of unit standard link */
     private UnitStandardLinkTypeEnum unitStandardLinkType;

    /**
     * Instantiates a new saqa us qualification.
     */
    public SaqaUsQualification() {
    }
     ...
     */
    public SaqaUsQualification(SaqaQualification saqaQualification, String nqfleveldescription, String nqflevelg2description, Integer qualificationid, Integer unitstandardid, Integer unitstdnumberofcredits, String unitstdtitle, String usqualtypedescription) {
 ...
 */
    ...
    @Enumerated
    @Column(name="unit_standard_link_type")
	public UnitStandardLinkTypeEnum getUnitStandardLinkType() {
		return unitStandardLinkType;
	}

	public void setUnitStandardLinkType(UnitStandardLinkTypeEnum unitStandardLinkType) {
		this.unitStandardLinkType = unitStandardLinkType;
	}
