...
/**
 * Excel name: Assessor
 * Tab Name: UnitStandard
 *
 * @author Techfinium
 */
@Entity
@Table(name = "UnitStandard")
public class UnitStandard extends AbstractLookup {
	
	/** The Constant serialVersionUID. */
	private static final long serialVersionUID = 1L;
	
	/** Unique Id of UnitStandard. */
	@Id
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		UnitStandard other = (UnitStandard) obj;
		if (id == null) {
			if (other.id != null)
				return false;
