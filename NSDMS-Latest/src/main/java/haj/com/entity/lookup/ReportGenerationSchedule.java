 ...
 */
@Entity
@Table(name = "report_generation_schedule")
public class ReportGenerationSchedule extends AbstractLookup {
	...
	@Column(name = "date_of_generation", length = 19)
	private Date dateOfGeneration;

	@Enumerated
	@Column(name = "report_generation_enum")
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ReportGenerationSchedule other = (ReportGenerationSchedule) obj;
		if (id == null) {
			if (other.id != null)
				return false;
