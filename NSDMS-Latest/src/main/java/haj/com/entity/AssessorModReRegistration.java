 ...
 */
@Entity
@Table(name = "assessor_mod_re_registration")
public class AssessorModReRegistration implements IDataEntity
{
	...
	@Column(name = "previous_create_date", length = 19)
	private Date previousCreateDate;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		AssessorModReRegistration other = (AssessorModReRegistration) obj;
		if (id == null) {
			if (other.id != null)
				return false;
	...
	public Date getPreviousCreateDate() {
		return previousCreateDate;
	}

	public void setPreviousCreateDate(Date previousCreateDate) {
		this.previousCreateDate = previousCreateDate;
	}
