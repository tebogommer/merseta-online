...
@Entity
@Table(name = "wsp_company_employees_history")
public class WspCompanyEmployeesHistory implements IDataEntity, Cloneable {
	...
	/** The Id of Employee Entity where referenced */
	@Column(name = "orginal_employees_id")
	private Long orginalEmployeesId;
	...
	@Column(name = "wsp_original_id")
	private Long wspOriginalId;
	
	@Column(name = "company_original_id")
	private Long companyOriginalId;
	...
	@Column(name = "site_original_id")
	private Long siteOriginalId;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		WspCompanyEmployeesHistory other = (WspCompanyEmployeesHistory) obj;
		if (id == null) {
			if (other.id != null)
				return false;
	...
	public Long getOrginalEmployeesId() {
		return orginalEmployeesId;
	}

	public void setOrginalEmployeesId(Long orginalEmployeesId) {
		this.orginalEmployeesId = orginalEmployeesId;
	}

	public Long getCompanyOriginalId() {
		return companyOriginalId;
	}

	public void setCompanyOriginalId(Long companyOriginalId) {
		this.companyOriginalId = companyOriginalId;
	}

	public Long getSiteOriginalId() {
		return siteOriginalId;
	}

	public void setSiteOriginalId(Long siteOriginalId) {
		this.siteOriginalId = siteOriginalId;
	}
	...
	public Long getWspOriginalId() {
		return wspOriginalId;
	}

	public void setWspOriginalId(Long wspOriginalId) {
		this.wspOriginalId = wspOriginalId;
	}
