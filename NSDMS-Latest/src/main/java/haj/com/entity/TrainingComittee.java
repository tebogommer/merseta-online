 ...
 */
@Entity
@Table(name = "training_comittee")
@ExportValidation(message = "Invalid Training Comittee Profile")
public class TrainingComittee implements IDataEntity,Cloneable {
	...
	@SETMISFieldValidation(className = UserValidationService.class, method = "validateNumber", paramClass = String.class, message = "Validation Failed For SETMIS Tel Number <ul><li>Field may not start with a space. If the value provided contains leading spaces then all leading spaces will be trimmed from the value during further validation of the data value provided</li><li>Uppercase value in field may only contain characters 1234567890 ()-</li><li>Uppercase value in field may not contain characters %UNKNOWN% or %AS ABOVE% or %SOOS BO% or %DELETE% or N/A or NA or U or NONE or GEEN or 0 or TEST or %ONTBREEK% or NIL/li></ul>", fieldName = "telNumber", fieldValue = "NOT_NULL")
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		TrainingComittee other = (TrainingComittee) obj;
		if (id == null) {
			if (other.id != null)
				return false;
