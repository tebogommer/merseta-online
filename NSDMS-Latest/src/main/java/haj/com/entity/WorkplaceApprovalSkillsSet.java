 ...
 */
@Entity
@Table(name = "work_place_approval_skills_set")
public class WorkplaceApprovalSkillsSet implements IDataEntity
{
	...
	public WorkplaceApprovalSkillsSet() {
		super();
		// TODO Auto-generated constructor stub
	}

    
	public WorkplaceApprovalSkillsSet(SkillsSet ss,	WorkPlaceApproval workPlaceApproval) {
		this.skillsSet=ss;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		WorkplaceApprovalSkillsSet other = (WorkplaceApprovalSkillsSet) obj;
		if (id == null) {
			if (other.id != null)
				return false;
