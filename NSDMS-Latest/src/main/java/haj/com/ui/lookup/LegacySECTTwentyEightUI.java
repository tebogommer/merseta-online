...
@ManagedBean(name = "legacysecttwentyeightUI")
@ViewScoped
public class LegacySECTTwentyEightUI extends AbstractUI {
...
//		columnMap = reportingService.convertToColumns(reportingMap);
	 ...
	 * @see LegacySECTTwentyEight
	 */
	public void legacysecttwentyeightInfoNew() {
		...
		dataModel = new LazyDataModel<LegacySECTTwentyEight>() {
			...
			public List<LegacySECTTwentyEight> load(int first, int pageSize, String sortField, SortOrder sortOrder,
				...
				try {
					retorno = service.allLegacyLegacySECTTwentyEightNew(first, pageSize, sortField, sortOrder, filters);
					dataModel.setRowCount(service.countAllLegacyLegacySECTTwentyEightNew(filters));
				} catch (Exception e) {
					logger.fatal(e);
				}
				return retorno;
