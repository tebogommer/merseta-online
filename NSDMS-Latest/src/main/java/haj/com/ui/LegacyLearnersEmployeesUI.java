...
@ManagedBean(name = "legacyLearnersEmployeesUI")
@ViewScoped
public class LegacyLearnersEmployeesUI extends AbstractUI {
	...
	private LegacyExperientialService segacyExperientialService = new LegacyExperientialService();
	private List<LegacyExperiential> legacyexperientialfilteredList = null;
	private LegacyExperiential legacyexperiential = null;
	private LazyDataModel<LegacyExperiential> dataModelLegacyExperiential;
		...
		companyDataModel = new LazyDataModel<Company>() {
			...
			public List<Company> load(int first, int pageSize, String sortField, SortOrder sortOrder,
				...
				try {
					...
					companyList = companyService.allCompanySetaCompanies(Company.class, first, pageSize, sortField, sortOrder,
							filters);
	...
	public void clearAll() {
		...
		dataModelLegacyExperiential=null;
	}
	...
	public void legacyexperientialInfo() {
		clearAll();
		dataModelLegacyExperiential = new LazyDataModel<LegacyExperiential>() {
			...
			public List<LegacyExperiential> load(int first, int pageSize, String sortField, SortOrder sortOrder,
				...
				try {
					filters.put("employerSdl", selectedCompany.getLevyNumber());
					retorno = segacyExperientialService.allLegacyExperiential(LegacyExperiential.class, first, pageSize, sortField, sortOrder, filters);
					dataModelLegacyExperiential.setRowCount(segacyExperientialService.count(LegacyExperiential.class, filters));
				} catch (Exception e) {
					logger.fatal(e);
					e.printStackTrace();
				}
	...
	public void redirectLegacyApprenticeship_vh() {
		try {
			System.out.println("Inside redirectLegacyApprenticeship_vh");
			...
			if(legacyapprenticeship.getSdlNo() == null || legacyapprenticeship.getSdlNo().isEmpty() || legacyapprenticeship.getSdlNo().equals("")) {
	...
	public void redirectLegacyBusary_vh() {
		try {
			if (getSessionUI().getTask() != null && getSessionUI().getTask().getId() != null ) {
				getSessionUI().setTask(null);
			}
			...
			if(legacybursary.getEmployerSdl()== null || legacybursary.getEmployerSdl().isEmpty() || legacybursary.getEmployerSdl().equals("")) {
				throw new Exception("Learner is not linked to an employer, please contact the merSETA Office");
			}
	...
	public void redirectLegacyInternship_vh() {
		try {
			if (getSessionUI().getTask() != null && getSessionUI().getTask().getId() != null ) {
				getSessionUI().setTask(null);
			}
			...
			if(legacyinternship.getEmployerSdl()== null || legacyinternship.getEmployerSdl().isEmpty() || legacyinternship.getEmployerSdl().equals("")) {
				throw new Exception("Learner is not linked to an employer, please contact the merSETA Office");
			}
	...
	public void redirectLegacyLearnership_vh() {		
		...
		if (getSessionUI().getTask() != null && getSessionUI().getTask().getId() != null ) {
			...
			if(legacylearnership.getEmployerSdl()== null || legacylearnership.getEmployerSdl().isEmpty() || legacylearnership.getEmployerSdl().equals("")) {
				throw new Exception("Learner is not linked to an employer , please contact the merSETA Office");
			}
			
			if(legacylearnership.getAccreditationNumber()== null || legacylearnership.getAccreditationNumber().isEmpty() || legacylearnership.getAccreditationNumber().equals("")) {
				throw new Exception("Learner is not linked to an training provider, please contact the merSETA Office");
			}
	...
	public void redirectLegacySkillsprogramme_vh() {
		try {
			System.out.println("getSessionUI().getTask():"+getSessionUI().getTask());
			if (getSessionUI().getTask() != null && getSessionUI().getTask().getId() != null ) {
				getSessionUI().setTask(null);
			}
			...
			if(legacyskillsprogramme.getEmployerSDL()== null || legacyskillsprogramme.getEmployerSDL().isEmpty() || legacyskillsprogramme.getEmployerSDL().equals("")) {
				throw new Exception("Learner is not linked to an employer , please contact the merSETA Office");
			}
			...
			if(legacyskillsprogramme.getAccreditationNumber()== null || legacyskillsprogramme.getAccreditationNumber().isEmpty() || legacyskillsprogramme.getAccreditationNumber().equals("")) {
				throw new Exception("Learner is not linked to an training provider, please contact the merSETA Office");
			}
	...
	public void redirectLegacytvet_vh() {
		try {
			if (getSessionUI().getTask() != null && getSessionUI().getTask().getId() != null ) {
				getSessionUI().setTask(null);
			}
			...
			if(legacytvet.getEmployerSDL()== null || legacytvet.getEmployerSDL().isEmpty() || legacytvet.getEmployerSDL().equals("")) {
				throw new Exception("Learner is not linked to an employer, please contact the merSETA Office");
			}
	...
	public void redirectLegacyUnitStandard_vh() {
		try {
			if (getSessionUI().getTask() != null && getSessionUI().getTask().getId() != null ) {
				getSessionUI().setTask(null);
			}
			...
			if(legacyunitstandard.getIdNo() == null && legacyunitstandard.getAlternateId().equalsIgnoreCase("")) {
			...
			if(legacyunitstandard.getEmployerSDL().isEmpty()) {
				throw new Exception("Learner is not linked to an employer , please contact the merSETA Office");
			}
			if(legacyunitstandard.getEmployerSDL().equalsIgnoreCase("")) {
				throw new Exception("Learner is not linked to an employer , please contact the merSETA Office");
			}
			...
			if(legacyunitstandard.getAccreditationNumber()== null ) {
				throw new Exception("Learner is not linked to a training provider, please contact the merSETA Office");
			}
			if(legacyunitstandard.getAccreditationNumber().isEmpty()) {
				throw new Exception("Learner is not linked to a training provider, please contact the merSETA Office");
			}
			if(legacyunitstandard.getAccreditationNumber().equals("")) {
				throw new Exception("Learner is not linked to a training provider, please contact the merSETA Office");
			}
	...
	public void redirectLegacySectTwentyEight_vh() {
		try {
			if (getSessionUI().getTask() != null && getSessionUI().getTask().getId() != null ) {
				getSessionUI().setTask(null);
			}			
			...
			if(legacysecttwentyeight.getSdlNo() != null && !legacysecttwentyeight.getSdlNo().isEmpty() && !legacysecttwentyeight.getSdlNo().equalsIgnoreCase("")) {
			...
			if(legacysecttwentyeight.getWasdl() != null && !legacysecttwentyeight.getWasdl().isEmpty() && !legacysecttwentyeight.getWasdl().equalsIgnoreCase("")) {
	...
	public void redirectLegacyexperiential_vh() {
		try {
			if (getSessionUI().getTask() != null && getSessionUI().getTask().getId() != null ) {
				getSessionUI().setTask(null);
			}			
			...
			if(legacyexperiential.getIdNo()  == null) {
				throw new Exception("RSA/Passport error when registering learner, please contact the merSETA Office");	
			}else if(legacyexperiential.getIdNo().equalsIgnoreCase("")) {
				throw new Exception("RSA/Passport error when registering learner, please contact the merSETA Office");
			}
			...
			if(legacyexperiential.getEmployerSdl()== null || legacyexperiential.getEmployerSdl().isEmpty() || legacyexperiential.getEmployerSdl().equals("")) {
				throw new Exception("Employer Sdl error when registering learner, please contact the merSETA Office");
			}
			
			selectedCompany = companyService.findByLevyNumber(legacyexperiential.getEmployerSdl());
			...
			legacyexperiential.setEmployer(selectedCompany);
			legacyexperiential.setCompany(selectedCompany);
			
			LegacyExperientialService.instance().update(legacyexperiential);
			
			super.setParameter("legacyexperientialId", this.legacyexperiential.getId(), true);
			super.ajaxRedirect("/pages/tp/legacyLearnerRegistrationForm.jsf");
		} catch (Exception e) {
			e.printStackTrace();
			logger.fatal(e);
	...
	public LazyDataModel<LegacyExperiential> getDataModelLegacyExperiential() {
		return dataModelLegacyExperiential;
	}
	...
	public void setDataModelLegacyExperiential(LazyDataModel<LegacyExperiential> dataModelLegacyExperiential) {
		this.dataModelLegacyExperiential = dataModelLegacyExperiential;
	}
}
