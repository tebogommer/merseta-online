...
import haj.com.service.HostingCompanyEmployeeTemplatesService;
import haj.com.service.HostingCompanyService;
import haj.com.utils.GenericUtility;

// TODO: Auto-generated Javadoc
/**
 * The Class HostingCompanyEmployeeTemplatesUI.
 */
@ManagedBean(name = "hostingCompanyEmployeeTemplatesUI")
@ViewScoped
public class HostingCompanyEmployeeTemplatesUI extends AbstractUI {
	...
	/** The template. */
	public HostingCompanyEmployeeTemplates template = null;
	...
	/** The service. */
	private HostingCompanyEmployeeTemplatesService service = new HostingCompanyEmployeeTemplatesService();

	/** The hosting company service. */
	private HostingCompanyService hostingCompanyService = new HostingCompanyService();

	/** Lists. */
	private List<HostingCompanyEmployeeTemplates> templateList = null;

	/** The templatefiltered list. */
	private List<HostingCompanyEmployeeTemplates> templatefilteredList = null;
	...
	private void runInit() throws Exception {
		service = new HostingCompanyEmployeeTemplatesService(getSessionUI().getMap());
	...
	private TreeNode buildTree() throws Exception {
		HostingCompanyEmployeeTemplates t = new HostingCompanyEmployeeTemplates();
	...
	public void prepareNewTemplate() {
		template = new HostingCompanyEmployeeTemplates();
	 ...
	 * @return the list
	 */
	public List<HostingCompanyEmployeeTemplates> complete(String desc) {
		List<HostingCompanyEmployeeTemplates> l = null;
		try {
	...
	public void readyForAdd() {
		if (selectedNode != null) {
			prepareNewTemplate();
			this.template.setParentTemplate((HostingCompanyEmployeeTemplates) selectedNode.getData());
	...
	public void deleteNode() {
		try {
			service.delete(service.findByKey((HostingCompanyEmployeeTemplates) selectedNode.getData()));
			templateInfo();
	...
	public void readyForEdit() {
		try {
			if (selectedNode != null) {
				this.template = (HostingCompanyEmployeeTemplates) selectedNode.getData();
	...
	public void onNodeSelect(NodeSelectEvent event) {
		this.template = (HostingCompanyEmployeeTemplates) event.getTreeNode().getData();
	...
	private void initDoc() {
		this.doc = new Doc();
		this.doc.setTargetClass(template.getClass().getName());
		this.doc.setTargetKey(template.getId());
	...
	private void findDocs() {
		try {
			this.docs = docService.searchByTargetKeyAndClass(template.getClass().getName(), template.getId());
		} catch (Exception e) {
			addErrorMessage(e.getMessage(), e);
		}
	}
	...
	public void onDragDrop(TreeDragDropEvent event) {
		try {
			...
			HostingCompanyEmployeeTemplates drag = service
					.findByKey((HostingCompanyEmployeeTemplates) dragNode.getData());
			HostingCompanyEmployeeTemplates drop = service
					.findByKey((HostingCompanyEmployeeTemplates) dropNode.getData());
	 ...
	 */
	public List<HostingCompanyEmployeeTemplates> getTemplateList() {
		return templateList;
	}
	 ...
	 *
	 * @param templateList
	 *            the new template list
	 */
	public void setTemplateList(List<HostingCompanyEmployeeTemplates> templateList) {
	 ...
	 */
	public List<HostingCompanyEmployeeTemplates> getTemplatefilteredList() {
	 ...
	 *
	 * @param templatefilteredList
	 *            the new templatefiltered list
	 */
	public void setTemplatefilteredList(List<HostingCompanyEmployeeTemplates> templatefilteredList) {
	 ...
	 * @return the template
	 */
	public HostingCompanyEmployeeTemplates getTemplate() {
		return template;
	}
	 ...
	 *            the new template
	 */
	public void setTemplate(HostingCompanyEmployeeTemplates template) {
