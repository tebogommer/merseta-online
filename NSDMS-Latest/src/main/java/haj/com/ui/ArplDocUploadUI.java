...
@ManagedBean(name = "arplDocUploadUI")
@ViewScoped
public class ArplDocUploadUI extends AbstractUI {
	...
	private void runInit() throws Exception {
		if (getSessionUI().getTask() != null && getSessionUI().getTask().getWorkflowProcess() == ConfigDocProcessEnum.ARPLTradeTestDocumentUpload) {
	...
	private void populateRejectionReasons() throws Exception{
		rejectionReasons = rejectReasonsService.locateReasonsSelectedByTargetKeyClassAndProcess(companyLearnersTradeTest.getId(), companyLearnersTradeTest.getClass().getName(), ConfigDocProcessEnum.ARPLTradeTestDocumentUpload);
	}
