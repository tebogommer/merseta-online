...
@ManagedBean(name = "dgallocationadditionalUI")
@ViewScoped
public class DgAllocationAdditionalUI extends AbstractUI {
	...
	public List<DGYear> getCurrentYears() throws Exception {
		return dgYearService.findByDatePivitol(getNow());
	}
	...
	private void findAllocations() throws Exception {
		if (dgYear != null) {
			allocations = dgAllocationService.allDgAllocationNotStatusAdditional(dgYear);
		}
	}
