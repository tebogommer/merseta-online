...
import haj.com.dao.QmrCandidacyProgrammeDataDAO;
...
/**
 * The Class QmrCandidacyProgrammeDataService.
 */
public class QmrCandidacyProgrammeDataService extends AbstractService {
	/** The dao. */
	private QmrCandidacyProgrammeDataDAO dao = new QmrCandidacyProgrammeDataDAO();
	...
	/**
	 * Get all QmrCandidacyProgrammeData.
	 *
	 * @author TechFinium
	 * @return a list of {@link haj.com.entity.QmrCandidacyProgrammeData}
	 * @throws Exception the exception
	 * @see QmrCandidacyProgrammeData
	 */
	public List<QmrCandidacyProgrammeData> allQmrCandidacyProgrammeData() throws Exception {
		return dao.allQmrCandidacyProgrammeData();
	}

	/**
	 * Create or update QmrCandidacyProgrammeData.
	 *
	 * @author TechFinium
	 ...
	 * @see QmrCandidacyProgrammeData
	 */
	public void create(QmrCandidacyProgrammeData entity) throws Exception {
	...
	/**
	 * Update QmrCandidacyProgrammeData.
	 *
	 * @author TechFinium
	 * @param entity the entity
	 * @throws Exception the exception
	 * @see QmrCandidacyProgrammeData
	 */
	public void update(QmrCandidacyProgrammeData entity) throws Exception {
		this.dao.update(entity);
	}

	/**
	 * Delete QmrCandidacyProgrammeData.
	 *
	 * @author TechFinium
	 * @param entity the entity
	 * @throws Exception the exception
	 * @see QmrCandidacyProgrammeData
	 */
	public void delete(QmrCandidacyProgrammeData entity) throws Exception {
	 ...
	 * @author TechFinium
	 * @param id the id
	 * @return a {@link haj.com.entity.QmrCandidacyProgrammeData}
	 * @throws Exception the exception
	 * @see QmrCandidacyProgrammeData
	 */
	public QmrCandidacyProgrammeData findByKey(long id) throws Exception {
		return dao.findByKey(id);
	}

	/**
	 * Find QmrCandidacyProgrammeData by description.
	 *
	 * @author TechFinium
	 * @param desc the desc
	 * @return a list of {@link haj.com.entity.QmrCandidacyProgrammeData}
	 ...
	 * @see QmrCandidacyProgrammeData
	 */
	public List<QmrCandidacyProgrammeData> findByName(String desc) throws Exception {
		return dao.findByName(desc);
	}

	/**
	 * Lazy load QmrCandidacyProgrammeData.
	 *
	 ...
	 * @throws Exception the exception
	 */
	public List<QmrCandidacyProgrammeData> allQmrCandidacyProgrammeData(int first, int pageSize) throws Exception {
		return dao.allQmrCandidacyProgrammeData(Long.valueOf(first), pageSize);
	}

	/**
	 * Get count of QmrCandidacyProgrammeData for lazy load.
	 *
	 * @author TechFinium
	 * @return Number of rows in the QmrCandidacyProgrammeData
	 * @throws Exception the exception
	 */
	public Long count() throws Exception {
		return dao.count(QmrCandidacyProgrammeData.class);
	}

	/**
	 * Lazy load QmrCandidacyProgrammeData with pagination, filter, sorting.
	 *
	 * @author TechFinium
	 * @param class1    QmrCandidacyProgrammeData class
	 * @param first     the first
	 * @param pageSize  the page size
	 * @param sortField the sort field
	 * @param sortOrder the sort order
	 * @param filters   the filters
	 * @return a list of {@link haj.com.entity.QmrCandidacyProgrammeData} containing data
	 * @throws Exception the exception
	 */
	@SuppressWarnings("unchecked")
	public List<QmrCandidacyProgrammeData> allQmrCandidacyProgrammeData(Class<QmrCandidacyProgrammeData> class1, int first, int pageSize, String sortField, SortOrder sortOrder, Map<String, Object> filters) throws Exception {
		return (List<QmrCandidacyProgrammeData>) dao.sortAndFilter(class1, first, pageSize, sortField, sortOrder, filters);

	}

	/**
	 * Get count of QmrCandidacyProgrammeData for lazy load with filters.
	 *
	 * @author TechFinium
	 * @param entity  QmrCandidacyProgrammeData class
	 * @param filters the filters
	 * @return Number of rows in the QmrCandidacyProgrammeData entity
	 * @throws Exception the exception
	 */
	public int count(Class<QmrCandidacyProgrammeData> entity, Map<String, Object> filters) throws Exception {
...
//					femaleCount = dao.countByYouthIdentfiedWithGenderAndEquity(selectedQuarter.getId(), employmentStatusEnum.get(0), qmrEnteredCompletedEnum, HAJConstants.QMR_AGE_YOUTH, QmrGenderEnum.FEMALE, report.getQmrEquityEnum());
	 ...
	 */
	public List<QmrSummaryBean> generateSummaryReportCandidacyProgrammeEntered(Integer finYearPassed) throws Exception {
		List<QmrTypeSelectionEnum> qmrTypeSelectionEnumList = QmrGenericService.instance().addQmrTypeSelectionEnumToArrayList(QmrTypeSelectionEnum.CANDIDACY_PROGRAMME);
	 ...
	 */
	public List<QmrSummaryBean> generateSummaryReportCandidacyProgrammeCompleted(Integer finYearPassed) throws Exception {
		List<QmrTypeSelectionEnum> qmrTypeSelectionEnumList = QmrGenericService.instance().addQmrTypeSelectionEnumToArrayList(QmrTypeSelectionEnum.CANDIDACY_PROGRAMME);
		List<EmploymentStatusEnum> employmentStatusEnum = null;
	...
	/*
	 * Generate Count Report: Candidacy Programme Entered
	 */
	public List<QmrQuarterCountBean> generateCountReportCandidacyProgrammeEntered(QmrFinYears selectedQuarter) throws Exception {
		List<QmrTypeSelectionEnum> qmrTypeSelectionEnumList = QmrGenericService.instance().addQmrTypeSelectionEnumToArrayList(QmrTypeSelectionEnum.CANDIDACY_PROGRAMME);
		List<EmploymentStatusEnum> employmentStatusEnum = null;
		List<LearnerStatusEnum> learnerStatusEnumList = QmrGenericService.instance().prepLearnerStatusEnumBasedOnIndicator(1);
		QmrEnteredCompletedEnum qmrEnteredCompletedEnum = QmrEnteredCompletedEnum.Entered;
	...
	/*
	 * Generate Count Report: Candidacy Programme Completed
	 */
	public List<QmrQuarterCountBean> generateCountReportCandidacyProgrammeCompleted(QmrFinYears selectedQuarter) throws Exception {
		List<QmrTypeSelectionEnum> qmrTypeSelectionEnumList = QmrGenericService.instance().addQmrTypeSelectionEnumToArrayList(QmrTypeSelectionEnum.CANDIDACY_PROGRAMME);
		List<EmploymentStatusEnum> employmentStatusEnum = null;
		List<LearnerStatusEnum> learnerStatusEnumList = QmrGenericService.instance().prepLearnerStatusEnumBasedOnIndicator(2);
		QmrEnteredCompletedEnum qmrEnteredCompletedEnum = QmrEnteredCompletedEnum.Completed;
	...
	/*
	 * Pull Candidacy Programme Entered: Data Report Saved Data
	 */
	public List<QmrCandidacyProgrammeData> fetchSavedDataCandidacyProgrammeEnteredForQuarter(QmrFinYears qmrFinYears) throws Exception {
		List<EmploymentStatusEnum> employmentStatusEnum = null;
		QmrEnteredCompletedEnum qmrEnteredCompletedEnum = QmrEnteredCompletedEnum.Entered;
		return dao.findDataForReport(qmrFinYears.getId(), employmentStatusEnum, qmrEnteredCompletedEnum);
	}
	
	public Integer fetchSavedDataCandidacyProgrammeEnteredForQuarterCount(QmrFinYears qmrFinYears) throws Exception {
		List<EmploymentStatusEnum> employmentStatusEnum = null;
		QmrEnteredCompletedEnum qmrEnteredCompletedEnum = QmrEnteredCompletedEnum.Entered;
	...
	/*
	 * Pull Candidacy Programme Completed: Data Report Saved Data
	 */
	public List<QmrCandidacyProgrammeData> fetchSavedDataCandidacyProgrammeCompletedForQuarter(QmrFinYears qmrFinYears) throws Exception {
		List<EmploymentStatusEnum> employmentStatusEnum = null;
		QmrEnteredCompletedEnum qmrEnteredCompletedEnum = QmrEnteredCompletedEnum.Completed;
		return dao.findDataForReport(qmrFinYears.getId(), employmentStatusEnum, qmrEnteredCompletedEnum);
	}
	
	public Integer fetchSavedDataCandidacyProgrammeCompletedForQuarterCount(QmrFinYears qmrFinYears) throws Exception {
		List<EmploymentStatusEnum> employmentStatusEnum = null;
		QmrEnteredCompletedEnum qmrEnteredCompletedEnum = QmrEnteredCompletedEnum.Completed;
		return dao.findDataForReportCount(qmrFinYears.getId(), employmentStatusEnum, qmrEnteredCompletedEnum);
	}
	...
	/*
	 * Pull Candidacy Programme Entered: Data Report Not Saved Data
	 */
	public List<QmrScriptOneBean> runCandidacyProgrammeEnteredForQuarterNotSaved(QmrFinYears qmrFinYears) throws Exception {
	...
	public List<CounterBean> runCandidacyProgrammeEnteredForQuarterNotSavedCount(QmrFinYears qmrFinYears) throws Exception {
		/* Prep data for report */
		List<QmrTypeSelectionEnum> qmrTypeSelectionEnumList = QmrGenericService.instance().addQmrTypeSelectionEnumToArrayList(QmrTypeSelectionEnum.CANDIDACY_PROGRAMME);
		List<EmploymentStatusEnum> employmentStatusEnum = null;
		List<LearnerStatusEnum> learnerStatusEnumList = QmrGenericService.instance().prepLearnerStatusEnumBasedOnIndicator(1);
	...
	/*
	 * Pull Candidacy Programme Completed: Data Report Not Saved Data
	 */
	public List<QmrScriptOneBean> runCandidacyProgrammeCompletedForQuarterNotSaved(QmrFinYears qmrFinYears) throws Exception {
		/* Prep data for report */
		List<QmrTypeSelectionEnum> qmrTypeSelectionEnumList = QmrGenericService.instance().addQmrTypeSelectionEnumToArrayList(QmrTypeSelectionEnum.CANDIDACY_PROGRAMME);
		List<EmploymentStatusEnum> employmentStatusEnum = null;
		List<LearnerStatusEnum> learnerStatusEnumList = QmrGenericService.instance().prepLearnerStatusEnumBasedOnIndicator(2);
	...
	public List<CounterBean> runCandidacyProgrammeCompletedForQuarterNotSavedCount(QmrFinYears qmrFinYears) throws Exception {
		/* Prep data for report */
		List<QmrTypeSelectionEnum> qmrTypeSelectionEnumList = QmrGenericService.instance().addQmrTypeSelectionEnumToArrayList(QmrTypeSelectionEnum.CANDIDACY_PROGRAMME);
		List<EmploymentStatusEnum> employmentStatusEnum = null;
		List<LearnerStatusEnum> learnerStatusEnumList = QmrGenericService.instance().prepLearnerStatusEnumBasedOnIndicator(2);
	...
	/**
	 * Generates List<haj.com.entity.QmrCandidacyProgrammeData> for a quarter provided. 
	 * 
	 * @param qmrFinYears
	 * @return List<QmrCandidacyProgrammeData>
	 * @throws Exception
	 */
	public List<QmrCandidacyProgrammeData> generateQuaterData(QmrFinYears qmrFinYears) throws Exception {
		
		List<QmrScriptOneBean> results = null;
		List<QmrCandidacyProgrammeData> transformedResults = null;
		List<QmrCandidacyProgrammeData> returnResults = new ArrayList<>();
		
		results = runCandidacyProgrammeEnteredForQuarterNotSaved(qmrFinYears);
		if (!results.isEmpty()) {
		...
		results = runCandidacyProgrammeCompletedForQuarterNotSaved(qmrFinYears);
		if (!results.isEmpty()) {
	 ...
	 * @throws Exception
	 */
	private List<QmrCandidacyProgrammeData> populateDataIntoReportingForm(List<QmrScriptOneBean> extractedResults, QmrFinYears qmrFinYears, QmrEnteredCompletedEnum qmrEnteredCompletedEnum, EmploymentStatusEnum employmentStatusEnum) throws Exception {
		List<QmrCandidacyProgrammeData> results = new ArrayList<>();
		for (QmrScriptOneBean bean : extractedResults) {
			QmrCandidacyProgrammeData newEntry = new QmrCandidacyProgrammeData();
