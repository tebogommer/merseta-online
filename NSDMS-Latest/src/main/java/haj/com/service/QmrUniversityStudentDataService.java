...
import haj.com.dao.QmrUniversityStudentDataDAO;
...
/**
 * The Class QmrUniversityStudentDataService.
 */
public class QmrUniversityStudentDataService extends AbstractService {
	/** The dao. */
	private QmrUniversityStudentDataDAO dao = new QmrUniversityStudentDataDAO();
	...
	/**
	 * Get all QmrUniversityStudentData.
	 *
	 * @author TechFinium
	 * @return a list of {@link haj.com.entity.QmrUniversityStudentData}
	 * @throws Exception the exception
	 * @see QmrUniversityStudentData
	 */
	public List<QmrUniversityStudentData> allQmrUniversityStudentData() throws Exception {
		return dao.allQmrUniversityStudentData();
	}

	/**
	 * Create or update QmrUniversityStudentData.
	 *
	 * @author TechFinium
	 ...
	 * @see QmrUniversityStudentData
	 */
	public void create(QmrUniversityStudentData entity) throws Exception {
	...
	/**
	 * Update QmrUniversityStudentData.
	 *
	 * @author TechFinium
	 * @param entity the entity
	 * @throws Exception the exception
	 * @see QmrUniversityStudentData
	 */
	public void update(QmrUniversityStudentData entity) throws Exception {
		this.dao.update(entity);
	}

	/**
	 * Delete QmrUniversityStudentData.
	 *
	 * @author TechFinium
	 * @param entity the entity
	 * @throws Exception the exception
	 * @see QmrUniversityStudentData
	 */
	public void delete(QmrUniversityStudentData entity) throws Exception {
	 ...
	 * @author TechFinium
	 * @param id the id
	 * @return a {@link haj.com.entity.QmrUniversityStudentData}
	 * @throws Exception the exception
	 * @see QmrUniversityStudentData
	 */
	public QmrUniversityStudentData findByKey(long id) throws Exception {
		return dao.findByKey(id);
	}

	/**
	 * Find QmrUniversityStudentData by description.
	 *
	 * @author TechFinium
	 * @param desc the desc
	 * @return a list of {@link haj.com.entity.QmrUniversityStudentData}
	 ...
	 * @see QmrUniversityStudentData
	 */
	public List<QmrUniversityStudentData> findByName(String desc) throws Exception {
		return dao.findByName(desc);
	}

	/**
	 * Lazy load QmrUniversityStudentData.
	 *
	 ...
	 * @throws Exception the exception
	 */
	public List<QmrUniversityStudentData> allQmrUniversityStudentData(int first, int pageSize) throws Exception {
		return dao.allQmrUniversityStudentData(Long.valueOf(first), pageSize);
	}

	/**
	 * Get count of QmrUniversityStudentData for lazy load.
	 *
	 * @author TechFinium
	 * @return Number of rows in the QmrUniversityStudentData
	 * @throws Exception the exception
	 */
	public Long count() throws Exception {
		return dao.count(QmrUniversityStudentData.class);
	}

	/**
	 * Lazy load QmrUniversityStudentData with pagination, filter, sorting.
	 *
	 * @author TechFinium
	 * @param class1    QmrUniversityStudentData class
	 * @param first     the first
	 * @param pageSize  the page size
	 * @param sortField the sort field
	 * @param sortOrder the sort order
	 * @param filters   the filters
	 * @return a list of {@link haj.com.entity.QmrUniversityStudentData} containing data
	 * @throws Exception the exception
	 */
	@SuppressWarnings("unchecked")
	public List<QmrUniversityStudentData> allQmrUniversityStudentData(Class<QmrUniversityStudentData> class1, int first, int pageSize, String sortField, SortOrder sortOrder, Map<String, Object> filters) throws Exception {
		return (List<QmrUniversityStudentData>) dao.sortAndFilter(class1, first, pageSize, sortField, sortOrder, filters);

	}

	/**
	 * Get count of QmrUniversityStudentData for lazy load with filters.
	 *
	 * @author TechFinium
	 * @param entity  QmrUniversityStudentData class
	 * @param filters the filters
	 * @return Number of rows in the QmrUniversityStudentData entity
	 * @throws Exception the exception
	 */
	public int count(Class<QmrUniversityStudentData> entity, Map<String, Object> filters) throws Exception {
...
//					femaleCount = dao.countByYouthIdentfiedWithGenderAndEquity(selectedQuarter.getId(), employmentStatusEnum.get(0), qmrEnteredCompletedEnum, HAJConstants.QMR_AGE_YOUTH, QmrGenderEnum.FEMALE, report.getQmrEquityEnum());
	 ...
	 * University Student Entered
	 */
	public List<QmrSummaryBean> generateSummaryReportUniversityStudentEntered(Integer finYearPassed) throws Exception {
		List<QmrTypeSelectionEnum> qmrTypeSelectionEnumList = QmrGenericService.instance().addQmrTypeSelectionEnumToArrayList(QmrTypeSelectionEnum.UNIVERSITY_STUDENT_PLACEMENT);
	...
	/*
	 * Generate Summary Report:
	 * University Student Completed
	 */
	public List<QmrSummaryBean> generateSummaryReportUniversityStudentCompleted(Integer finYearPassed) throws Exception {
		List<QmrTypeSelectionEnum> qmrTypeSelectionEnumList = QmrGenericService.instance().addQmrTypeSelectionEnumToArrayList(QmrTypeSelectionEnum.UNIVERSITY_STUDENT_PLACEMENT);
		List<EmploymentStatusEnum> employmentStatusEnum = null;
	...
	/*
	 * Generate Count Report: University Student Entered
	 */
	public List<QmrQuarterCountBean> generateCountReportUniversityStudentEntered(QmrFinYears selectedQuarter) throws Exception {
		List<QmrTypeSelectionEnum> qmrTypeSelectionEnumList = QmrGenericService.instance().addQmrTypeSelectionEnumToArrayList(QmrTypeSelectionEnum.UNIVERSITY_STUDENT_PLACEMENT);
		List<EmploymentStatusEnum> employmentStatusEnum = null;
		List<LearnerStatusEnum> learnerStatusEnumList = QmrGenericService.instance().prepLearnerStatusEnumBasedOnIndicator(1);
		QmrEnteredCompletedEnum qmrEnteredCompletedEnum = QmrEnteredCompletedEnum.Entered;
	...
	/*
	 * Generate Count Report: University Student Completed
	 */
	public List<QmrQuarterCountBean> generateCountReportUniversityStudentCompleted(QmrFinYears selectedQuarter) throws Exception {
		List<QmrTypeSelectionEnum> qmrTypeSelectionEnumList = QmrGenericService.instance().addQmrTypeSelectionEnumToArrayList(QmrTypeSelectionEnum.UNIVERSITY_STUDENT_PLACEMENT);
		List<EmploymentStatusEnum> employmentStatusEnum = null;
		List<LearnerStatusEnum> learnerStatusEnumList = QmrGenericService.instance().prepLearnerStatusEnumBasedOnIndicator(2);
		QmrEnteredCompletedEnum qmrEnteredCompletedEnum = QmrEnteredCompletedEnum.Completed;
	...
	/*
	 * Pull University Student Entered: Data Report Saved Data
	 */
	public List<QmrUniversityStudentData> fetchSavedDataUniversityStudentEnteredForQuarter(QmrFinYears qmrFinYears) throws Exception {
		List<EmploymentStatusEnum> employmentStatusEnum = null;
		QmrEnteredCompletedEnum qmrEnteredCompletedEnum = QmrEnteredCompletedEnum.Entered;
		return dao.findDataForReport(qmrFinYears.getId(), employmentStatusEnum, qmrEnteredCompletedEnum);
	}
	
	public Integer fetchSavedDataUniversityStudentEnteredForQuarterCount(QmrFinYears qmrFinYears) throws Exception {
		List<EmploymentStatusEnum> employmentStatusEnum = null;
		QmrEnteredCompletedEnum qmrEnteredCompletedEnum = QmrEnteredCompletedEnum.Entered;
	...
	/*
	 * Pull University Student Completed: Data Report Saved Data
	 */
	public List<QmrUniversityStudentData> fetchSavedDataUniversityStudentCompletedForQuarter(QmrFinYears qmrFinYears) throws Exception {
		List<EmploymentStatusEnum> employmentStatusEnum = null;
		QmrEnteredCompletedEnum qmrEnteredCompletedEnum = QmrEnteredCompletedEnum.Completed;
		return dao.findDataForReport(qmrFinYears.getId(), employmentStatusEnum, qmrEnteredCompletedEnum);
	}
	
	public Integer fetchSavedDataUniversityStudentCompletedForQuarterCount(QmrFinYears qmrFinYears) throws Exception {
		List<EmploymentStatusEnum> employmentStatusEnum = null;
		QmrEnteredCompletedEnum qmrEnteredCompletedEnum = QmrEnteredCompletedEnum.Completed;
		return dao.findDataForReportCount(qmrFinYears.getId(), employmentStatusEnum, qmrEnteredCompletedEnum);
	}
	...
	/*
	 * Pull University Student Entered: Data Report Not Saved Data
	 */
	public List<QmrScriptFourBean> runUniversityStudentEnteredForQuarterNotSaved(QmrFinYears qmrFinYears) throws Exception {
	...
	public List<CounterBean> runUniversityStudentEnteredForQuarterNotSavedCount(QmrFinYears qmrFinYears) throws Exception {
		/* Prep data for report */
		List<QmrTypeSelectionEnum> qmrTypeSelectionEnumList = QmrGenericService.instance().addQmrTypeSelectionEnumToArrayList(QmrTypeSelectionEnum.UNIVERSITY_STUDENT_PLACEMENT);
		List<EmploymentStatusEnum> employmentStatusEnum = null;
		List<LearnerStatusEnum> learnerStatusEnumList = QmrGenericService.instance().prepLearnerStatusEnumBasedOnIndicator(1);
	...
	/*
	 * Pull University Student Completed: Data Report Not Saved Data
	 */
	public List<QmrScriptFourBean> runUniversityStudentCompletedForQuarterNotSaved(QmrFinYears qmrFinYears) throws Exception {
		/* Prep data for report */
		List<QmrTypeSelectionEnum> qmrTypeSelectionEnumList = QmrGenericService.instance().addQmrTypeSelectionEnumToArrayList(QmrTypeSelectionEnum.UNIVERSITY_STUDENT_PLACEMENT);
		List<EmploymentStatusEnum> employmentStatusEnum = null;
		List<LearnerStatusEnum> learnerStatusEnumList = QmrGenericService.instance().prepLearnerStatusEnumBasedOnIndicator(2);
	...
	public List<CounterBean> runUniversityStudentCompletedForQuarterNotSavedCount(QmrFinYears qmrFinYears) throws Exception {
		/* Prep data for report */
		List<QmrTypeSelectionEnum> qmrTypeSelectionEnumList = QmrGenericService.instance().addQmrTypeSelectionEnumToArrayList(QmrTypeSelectionEnum.UNIVERSITY_STUDENT_PLACEMENT);
		List<EmploymentStatusEnum> employmentStatusEnum = null;
		List<LearnerStatusEnum> learnerStatusEnumList = QmrGenericService.instance().prepLearnerStatusEnumBasedOnIndicator(2);
	...
	/**
	 * Generates List<haj.com.entity.QmrUniversityStudentData> for a quarter provided. 
	 * 
	 * @param qmrFinYears
	 * @return List<QmrUniversityStudentData>
	 * @throws Exception
	 */
	public List<QmrUniversityStudentData> generateQuaterData(QmrFinYears qmrFinYears) throws Exception {

		List<QmrScriptFourBean> results = null;
		List<QmrUniversityStudentData> transformedResults = null;
		List<QmrUniversityStudentData> returnResults = new ArrayList<>();
		
		results = runUniversityStudentEnteredForQuarterNotSaved(qmrFinYears);
		if (!results.isEmpty()) {
		...
		results = runUniversityStudentCompletedForQuarterNotSaved(qmrFinYears);
		if (!results.isEmpty()) {
	 ...
	 * @throws Exception
	 */
	private List<QmrUniversityStudentData> populateDataIntoReportingForm(List<QmrScriptFourBean> extractedResults, QmrFinYears qmrFinYears, QmrEnteredCompletedEnum qmrEnteredCompletedEnum, EmploymentStatusEnum employmentStatusEnum) throws Exception {
		List<QmrUniversityStudentData> results = new ArrayList<>();
		for (QmrScriptFourBean bean : extractedResults) {
			QmrUniversityStudentData newEntry = new QmrUniversityStudentData();
