...
import haj.com.dao.QmrInternshipDataDAO;
...
/**
 * The Class QmrInternshipDataService.
 */
public class QmrInternshipDataService extends AbstractService {
	/** The dao. */
	private QmrInternshipDataDAO dao = new QmrInternshipDataDAO();
	...
	public List<QmrInternshipData> allQmrInternshipData() throws Exception {
		return dao.allQmrInternshipData();
	}

	/**
	 * Create or update QmrInternshipData.
	 *
	 * @author TechFinium
	 ...
	 * @see QmrInternshipData
	 */
	public void create(QmrInternshipData entity) throws Exception {
	 ...
	 * @see QmrInternshipData
	 */
	public void update(QmrInternshipData entity) throws Exception {
		this.dao.update(entity);
	}

	/**
	 * Delete QmrInternshipData.
	 *
	 * @author TechFinium
	 * @param entity the entity
	 * @throws Exception the exception
	 * @see QmrInternshipData
	 */
	public void delete(QmrInternshipData entity) throws Exception {
	 ...
	 * @see QmrInternshipData
	 */
	public List<QmrInternshipData> findByName(String desc) throws Exception {
		return dao.findByName(desc);
	}

	/**
	 * Lazy load QmrInternshipData.
	 *
	 ...
	 * @throws Exception the exception
	 */
	public List<QmrInternshipData> allQmrInternshipData(int first, int pageSize) throws Exception {
		return dao.allQmrInternshipData(Long.valueOf(first), pageSize);
	}

	/**
	 * Get count of QmrInternshipData for lazy load.
	 *
	 * @author TechFinium
	 * @return Number of rows in the QmrInternshipData
	 * @throws Exception the exception
	 */
	public Long count() throws Exception {
		return dao.count(QmrInternshipData.class);
	}

	/**
	 * Lazy load QmrInternshipData with pagination, filter, sorting.
	 *
	 * @author TechFinium
	 * @param class1    QmrInternshipData class
	 * @param first     the first
	 * @param pageSize  the page size
	 * @param sortField the sort field
	 * @param sortOrder the sort order
	 * @param filters   the filters
	 * @return a list of {@link haj.com.entity.QmrInternshipData} containing data
	 * @throws Exception the exception
	 */
	@SuppressWarnings("unchecked")
	public List<QmrInternshipData> allQmrInternshipData(Class<QmrInternshipData> class1, int first, int pageSize, String sortField, SortOrder sortOrder, Map<String, Object> filters) throws Exception {
		return (List<QmrInternshipData>) dao.sortAndFilter(class1, first, pageSize, sortField, sortOrder, filters);

	}

	/**
	 * Get count of QmrInternshipData for lazy load with filters.
	 *
	 * @author TechFinium
	 * @param entity  QmrInternshipData class
	 * @param filters the filters
	 * @return Number of rows in the QmrInternshipData entity
	 * @throws Exception the exception
	 */
	public int count(Class<QmrInternshipData> entity, Map<String, Object> filters) throws Exception {
...
//					femaleCount = dao.countByYouthIdentfiedWithGenderAndEquity(selectedQuarter.getId(), employmentStatusEnum.get(0), qmrEnteredCompletedEnum, HAJConstants.QMR_AGE_YOUTH, QmrGenderEnum.FEMALE, report.getQmrEquityEnum());
	 ...
	 * Internship Unemployed Entered
	 */
	public List<QmrSummaryBean> generateSummaryReportInternshipUnemployedEntered(Integer finYearPassed) throws Exception {
		List<QmrTypeSelectionEnum> qmrTypeSelectionEnumList = QmrGenericService.instance().addQmrTypeSelectionEnumToArrayList(QmrTypeSelectionEnum.INTERNSHIPS);
	...
	/*
	 * Generate Summary Report:
	 * Internship Unemployed Completed
	 */
	public List<QmrSummaryBean> generateSummaryReportInternshipUnemployedCompleted(Integer finYearPassed) throws Exception {
		List<QmrTypeSelectionEnum> qmrTypeSelectionEnumList = QmrGenericService.instance().addQmrTypeSelectionEnumToArrayList(QmrTypeSelectionEnum.INTERNSHIPS);
		List<EmploymentStatusEnum> employmentStatusEnum = QmrGenericService.instance().addEmploymentStatusEnumToArrayList(EmploymentStatusEnum.UnEmployed);
	...
	/*
	 * Generate Count Report: Internship Unemployed Entered
	 */
	public List<QmrQuarterCountBean> generateCountReportInternshipUnemployedEntered(QmrFinYears selectedQuarter) throws Exception {
		List<QmrTypeSelectionEnum> qmrTypeSelectionEnumList = QmrGenericService.instance().addQmrTypeSelectionEnumToArrayList(QmrTypeSelectionEnum.INTERNSHIPS);
		List<EmploymentStatusEnum> employmentStatusEnum = QmrGenericService.instance().addEmploymentStatusEnumToArrayList(EmploymentStatusEnum.UnEmployed);
		List<LearnerStatusEnum> learnerStatusEnumList = QmrGenericService.instance().prepLearnerStatusEnumBasedOnIndicator(1);
		QmrEnteredCompletedEnum qmrEnteredCompletedEnum = QmrEnteredCompletedEnum.Entered;
	...
	/*
	 * Generate Count Report: Internship Unemployed Completed
	 */
	public List<QmrQuarterCountBean> generateCountReportInternshipUnemployedCompleted(QmrFinYears selectedQuarter) throws Exception {
		List<QmrTypeSelectionEnum> qmrTypeSelectionEnumList = QmrGenericService.instance().addQmrTypeSelectionEnumToArrayList(QmrTypeSelectionEnum.INTERNSHIPS);
		List<EmploymentStatusEnum> employmentStatusEnum = QmrGenericService.instance().addEmploymentStatusEnumToArrayList(EmploymentStatusEnum.UnEmployed);
		List<LearnerStatusEnum> learnerStatusEnumList = QmrGenericService.instance().prepLearnerStatusEnumBasedOnIndicator(2);
		QmrEnteredCompletedEnum qmrEnteredCompletedEnum = QmrEnteredCompletedEnum.Completed;
	...
	/*
	 * Pull InternshipUnemployed Entered: Data Report Saved Data
	 */
	public List<QmrInternshipData> fetchSavedDataInternshipUnemployedEnteredForQuarter(QmrFinYears qmrFinYears) throws Exception {
		List<EmploymentStatusEnum> employmentStatusEnum = QmrGenericService.instance().addEmploymentStatusEnumToArrayList(EmploymentStatusEnum.UnEmployed);
		QmrEnteredCompletedEnum qmrEnteredCompletedEnum = QmrEnteredCompletedEnum.Entered;
		return dao.findDataForReport(qmrFinYears.getId(), employmentStatusEnum, qmrEnteredCompletedEnum);
	}
	
	public Integer fetchSavedDataInternshipUnemployedEnteredForQuarterCount(QmrFinYears qmrFinYears) throws Exception {
		List<EmploymentStatusEnum> employmentStatusEnum = QmrGenericService.instance().addEmploymentStatusEnumToArrayList(EmploymentStatusEnum.UnEmployed);
		QmrEnteredCompletedEnum qmrEnteredCompletedEnum = QmrEnteredCompletedEnum.Entered;
	...
	/*
	 * Pull InternshipUnemployed Completed: Data Report Saved Data
	 */
	public List<QmrInternshipData> fetchSavedDataInternshipUnemployedCompletedForQuarter(QmrFinYears qmrFinYears) throws Exception {
		List<EmploymentStatusEnum> employmentStatusEnum = QmrGenericService.instance().addEmploymentStatusEnumToArrayList(EmploymentStatusEnum.UnEmployed);
		QmrEnteredCompletedEnum qmrEnteredCompletedEnum = QmrEnteredCompletedEnum.Completed;
		return dao.findDataForReport(qmrFinYears.getId(), employmentStatusEnum, qmrEnteredCompletedEnum);
	}
	
	public Integer fetchSavedDataInternshipUnemployedCompletedForQuarterCount(QmrFinYears qmrFinYears) throws Exception {
		List<EmploymentStatusEnum> employmentStatusEnum = QmrGenericService.instance().addEmploymentStatusEnumToArrayList(EmploymentStatusEnum.UnEmployed);
		QmrEnteredCompletedEnum qmrEnteredCompletedEnum = QmrEnteredCompletedEnum.Completed;
		return dao.findDataForReportCount(qmrFinYears.getId(), employmentStatusEnum, qmrEnteredCompletedEnum);
	}
	...
	/*
	 * Pull Internship Unemployed Entered: Data Report Not Saved Data
	 */
	public List<QmrScriptOneBean> runInternshipUnemployedEnteredForQuarterNotSaved(QmrFinYears qmrFinYears) throws Exception {
	...
	public List<CounterBean> runInternshipUnemployedEnteredForQuarterNotSavedCount(QmrFinYears qmrFinYears) throws Exception {
		/* Prep data for report */
		List<QmrTypeSelectionEnum> qmrTypeSelectionEnumList = QmrGenericService.instance().addQmrTypeSelectionEnumToArrayList(QmrTypeSelectionEnum.INTERNSHIPS);
		List<EmploymentStatusEnum> employmentStatusEnum = QmrGenericService.instance().addEmploymentStatusEnumToArrayList(EmploymentStatusEnum.UnEmployed);
		List<LearnerStatusEnum> learnerStatusEnumList = QmrGenericService.instance().prepLearnerStatusEnumBasedOnIndicator(1);
	...
	/*
	 * Pull Internship Unemployed Completed: Data Report Not Saved Data
	 */
	public List<QmrScriptOneBean> runInternshipUnemployedCompletedForQuarterNotSaved(QmrFinYears qmrFinYears) throws Exception {
		/* Prep data for report */
		List<QmrTypeSelectionEnum> qmrTypeSelectionEnumList = QmrGenericService.instance().addQmrTypeSelectionEnumToArrayList(QmrTypeSelectionEnum.INTERNSHIPS);
		List<EmploymentStatusEnum> employmentStatusEnum = QmrGenericService.instance().addEmploymentStatusEnumToArrayList(EmploymentStatusEnum.UnEmployed);
		List<LearnerStatusEnum> learnerStatusEnumList = QmrGenericService.instance().prepLearnerStatusEnumBasedOnIndicator(2);
	...
	public List<CounterBean> runInternshipUnemployedCompletedForQuarterNotSavedCount(QmrFinYears qmrFinYears) throws Exception {
		/* Prep data for report */
		List<QmrTypeSelectionEnum> qmrTypeSelectionEnumList = QmrGenericService.instance().addQmrTypeSelectionEnumToArrayList(QmrTypeSelectionEnum.INTERNSHIPS);
		List<EmploymentStatusEnum> employmentStatusEnum = QmrGenericService.instance().addEmploymentStatusEnumToArrayList(EmploymentStatusEnum.UnEmployed);
		List<LearnerStatusEnum> learnerStatusEnumList = QmrGenericService.instance().prepLearnerStatusEnumBasedOnIndicator(2);
	...
	/**
	 * Generates List<haj.com.entity.QmrInternshipData> for a quarter provided. 
	 * 
	 * @param qmrFinYears
	 * @return List<QmrInternshipData>
	 * @throws Exception
	 */
	public List<QmrInternshipData> generateQmrInternshipDataForQuater(QmrFinYears qmrFinYears) throws Exception {
		
		List<QmrScriptOneBean> results = null;
		List<QmrInternshipData> transformedResults = null;
		List<QmrInternshipData> returnResults = new ArrayList<>();
		
		results = runInternshipUnemployedEnteredForQuarterNotSaved(qmrFinYears);
		if (!results.isEmpty()) {
		...
		results = runInternshipUnemployedCompletedForQuarterNotSaved(qmrFinYears);
		if (!results.isEmpty()) {
	 ...
	 * @throws Exception
	 */
	private List<QmrInternshipData> populateDataIntoReportingForm(List<QmrScriptOneBean> extractedResults, QmrFinYears qmrFinYears, QmrEnteredCompletedEnum qmrEnteredCompletedEnum, EmploymentStatusEnum employmentStatusEnum) throws Exception {
		List<QmrInternshipData> results = new ArrayList<>();
		for (QmrScriptOneBean bean : extractedResults) {
			QmrInternshipData newEntry = new QmrInternshipData();
