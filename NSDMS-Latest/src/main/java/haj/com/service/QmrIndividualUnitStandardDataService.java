...
import haj.com.dao.QmrIndividualUnitStandardDataDAO;
...
/**
 * The Class QmrIndividualUnitStandardDataService.
 */
public class QmrIndividualUnitStandardDataService extends AbstractService {
	/** The dao. */
	private QmrIndividualUnitStandardDataDAO dao = new QmrIndividualUnitStandardDataDAO();
	...
	public List<QmrIndividualUnitStandardData> allQmrIndividualUnitStandardData() throws Exception {
		return dao.allQmrIndividualUnitStandardData();
	}

	/**
	 * Create or update QmrIndividualUnitStandardData.
	 *
	 * @author TechFinium
	 ...
	 * @see QmrIndividualUnitStandardData
	 */
	public void create(QmrIndividualUnitStandardData entity) throws Exception {
	...
	/**
	 * Update QmrIndividualUnitStandardData.
	 *
	 * @author TechFinium
	 * @param entity the entity
	 * @throws Exception the exception
	 * @see QmrIndividualUnitStandardData
	 */
	public void update(QmrIndividualUnitStandardData entity) throws Exception {
		this.dao.update(entity);
	}

	/**
	 * Delete QmrIndividualUnitStandardData.
	 *
	 * @author TechFinium
	 * @param entity the entity
	 * @throws Exception the exception
	 * @see QmrIndividualUnitStandardData
	 */
	public void delete(QmrIndividualUnitStandardData entity) throws Exception {
	 ...
	 * @see QmrIndividualUnitStandardData
	 */
	public List<QmrIndividualUnitStandardData> findByName(String desc) throws Exception {
		return dao.findByName(desc);
	}

	/**
	 * Lazy load QmrIndividualUnitStandardData.
	 *
	 ...
	 * @throws Exception the exception
	 */
	public List<QmrIndividualUnitStandardData> allQmrIndividualUnitStandardData(int first, int pageSize) throws Exception {
		return dao.allQmrIndividualUnitStandardData(Long.valueOf(first), pageSize);
	}

	/**
	 * Get count of QmrIndividualUnitStandardData for lazy load.
	 *
	 * @author TechFinium
	 * @return Number of rows in the QmrIndividualUnitStandardData
	 * @throws Exception the exception
	 */
	public Long count() throws Exception {
		return dao.count(QmrIndividualUnitStandardData.class);
	}

	/**
	 * Lazy load QmrIndividualUnitStandardData with pagination, filter, sorting.
	 *
	 * @author TechFinium
	 * @param class1    QmrIndividualUnitStandardData class
	 * @param first     the first
	 * @param pageSize  the page size
	 * @param sortField the sort field
	 * @param sortOrder the sort order
	 * @param filters   the filters
	 * @return a list of {@link haj.com.entity.QmrIndividualUnitStandardData} containing data
	 * @throws Exception the exception
	 */
	@SuppressWarnings("unchecked")
	public List<QmrIndividualUnitStandardData> allQmrIndividualUnitStandardData(Class<QmrIndividualUnitStandardData> class1, int first, int pageSize, String sortField, SortOrder sortOrder, Map<String, Object> filters) throws Exception {
		return (List<QmrIndividualUnitStandardData>) dao.sortAndFilter(class1, first, pageSize, sortField, sortOrder, filters);

	}

	/**
	 * Get count of QmrIndividualUnitStandardData for lazy load with filters.
	 *
	 * @author TechFinium
	 * @param entity  QmrIndividualUnitStandardData class
	 * @param filters the filters
	 * @return Number of rows in the QmrIndividualUnitStandardData entity
	 * @throws Exception the exception
	 */
	public int count(Class<QmrIndividualUnitStandardData> entity, Map<String, Object> filters) throws Exception {
...
//		}
	 ...
	 * Individual Unit Standard Entered
	 */
	public List<QmrSummaryBean> generateSummaryReportIndividualUnitStandardEntered(Integer finYearPassed) throws Exception {
		List<QmrTypeSelectionEnum> qmrTypeSelectionEnumList = QmrGenericService.instance().addQmrTypeSelectionEnumToArrayList(QmrTypeSelectionEnum.INDIVIDUAL_UNIT_STANDARD);
	...
	/*
	 * Generate Summary Report:
	 * Individual Unit Standard Completed
	 */
	public List<QmrSummaryBean> generateSummaryReportIndividualUnitStandardCompleted(Integer finYearPassed) throws Exception {
		List<QmrTypeSelectionEnum> qmrTypeSelectionEnumList = QmrGenericService.instance().addQmrTypeSelectionEnumToArrayList(QmrTypeSelectionEnum.INDIVIDUAL_UNIT_STANDARD);
		List<EmploymentStatusEnum> employmentStatusEnum = null;
	...
	/*
	 * Generate Count Report: Individual Unit Standard Entered
	 */
	public List<QmrQuarterCountBean> generateCountReportIndividualUnitStandardEntered(QmrFinYears selectedQuarter) throws Exception {
		List<QmrTypeSelectionEnum> qmrTypeSelectionEnumList = QmrGenericService.instance().addQmrTypeSelectionEnumToArrayList(QmrTypeSelectionEnum.INDIVIDUAL_UNIT_STANDARD);
		List<EmploymentStatusEnum> employmentStatusEnum = null;
		List<LearnerStatusEnum> learnerStatusEnumList = QmrGenericService.instance().prepLearnerStatusEnumBasedOnIndicator(1);
		QmrEnteredCompletedEnum qmrEnteredCompletedEnum = QmrEnteredCompletedEnum.Entered;
	...
	/*
	 * Generate Count Report: Individual Unit Standard Completed
	 */
	public List<QmrQuarterCountBean> generateCountReportIndividualUnitStandardCompleted(QmrFinYears selectedQuarter) throws Exception {
		List<QmrTypeSelectionEnum> qmrTypeSelectionEnumList = QmrGenericService.instance().addQmrTypeSelectionEnumToArrayList(QmrTypeSelectionEnum.INDIVIDUAL_UNIT_STANDARD);
		List<EmploymentStatusEnum> employmentStatusEnum = null;
		List<LearnerStatusEnum> learnerStatusEnumList = QmrGenericService.instance().prepLearnerStatusEnumBasedOnIndicator(2);
		QmrEnteredCompletedEnum qmrEnteredCompletedEnum = QmrEnteredCompletedEnum.Completed;
	...
	/*
	 * Pull Individual Unit Standard Entered: Data Report Saved Data
	 */
	public List<QmrIndividualUnitStandardData> fetchSavedDataIndividualUnitStandardEnteredForQuarter(QmrFinYears qmrFinYears) throws Exception {
		List<EmploymentStatusEnum> employmentStatusEnum = null;
		QmrEnteredCompletedEnum qmrEnteredCompletedEnum = QmrEnteredCompletedEnum.Entered;
	...
	/*
	 * Pull Individual Unit Standard Completed: Data Report Saved Data
	 */
	public List<QmrIndividualUnitStandardData> fetchSavedDataIndividualUnitStandardCompletedForQuarter(QmrFinYears qmrFinYears) throws Exception {
		List<EmploymentStatusEnum> employmentStatusEnum = null;
		QmrEnteredCompletedEnum qmrEnteredCompletedEnum = QmrEnteredCompletedEnum.Completed;
		return dao.findDataForReport(qmrFinYears.getId(), employmentStatusEnum, qmrEnteredCompletedEnum);
	}
	...
	/*
	 * Pull Individual Unit Standard Entered: Data Report Not Saved Data
	 */
	public List<QmrScriptOneBean> runIndividualUnitStandardEnteredForQuarterNotSaved(QmrFinYears qmrFinYears) throws Exception {
	...
	/*
	 * Pull Individual Unit Standard Completed: Data Report Not Saved Data
	 */
	public List<QmrScriptOneBean> runIndividualUnitStandardCompletedForQuarterNotSaved(QmrFinYears qmrFinYears) throws Exception {
		/* Prep data for report */
		List<QmrTypeSelectionEnum> qmrTypeSelectionEnumList = QmrGenericService.instance().addQmrTypeSelectionEnumToArrayList(QmrTypeSelectionEnum.INDIVIDUAL_UNIT_STANDARD);
		List<EmploymentStatusEnum> employmentStatusEnum = null;
		List<LearnerStatusEnum> learnerStatusEnumList = QmrGenericService.instance().prepLearnerStatusEnumBasedOnIndicator(2);
	...
	/**
	 * Generates List<haj.com.entity.QmrIndividualUnitStandardData> for a quarter provided. 
	 * 
	 * @param qmrFinYears
	 * @return List<QmrIndividualUnitStandardData>
	 * @throws Exception
	 */
	public List<QmrIndividualUnitStandardData> generateQuaterData(QmrFinYears qmrFinYears) throws Exception {

		List<QmrScriptOneBean> results = null;
		List<QmrIndividualUnitStandardData> transformedResults = null;
		List<QmrIndividualUnitStandardData> returnResults = new ArrayList<>();
		
		results = runIndividualUnitStandardEnteredForQuarterNotSaved(qmrFinYears);
		if (!results.isEmpty()) {
		...
		results = runIndividualUnitStandardCompletedForQuarterNotSaved(qmrFinYears);
		if (!results.isEmpty()) {
	 ...
	 * @throws Exception
	 */
	private List<QmrIndividualUnitStandardData> populateDataIntoReportingForm(List<QmrScriptOneBean> extractedResults, QmrFinYears qmrFinYears, QmrEnteredCompletedEnum qmrEnteredCompletedEnum, EmploymentStatusEnum employmentStatusEnum) throws Exception {
		List<QmrIndividualUnitStandardData> results = new ArrayList<>();
		for (QmrScriptOneBean bean : extractedResults) {
			QmrIndividualUnitStandardData newEntry = new QmrIndividualUnitStandardData();
