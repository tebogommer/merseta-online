    ...
    <main className="min-h-screen bg-gray-50 p-8">
      <div className="max-w-4xl mx-auto mb-6">
        <div className="flex justify-between items-center bg-white p-4 rounded-lg shadow-sm border border-gray-200">
          <Link href={`/providers`} className="text-gray-500 hover:text-gray-900 inline-flex items-center gap-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="md:col-span-2 space-y-6">
                    <h3 className="text-lg font-semibold text-gray-900 border-b pb-2 flex items-center gap-2">
                        <Building2 className="w-5 h-5 text-gray-400" /> Core Accreditation Details
                    </h3>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            <label className="block text-sm font-semibold text-gray-700 mb-2">Provider Type ID *</label>
                            <input name="providerTypeId" type="number" defaultValue={1} className="w-full px-4 py-2 border border-gray-300 rounded focus:ring-2 focus:ring-primary focus:outline-none" />
                            <FieldError field="providerTypeId" />
                        </div>

                        <div className="md:col-span-2">
                            <label className="block text-sm font-semibold text-gray-700 mb-2">Accreditation Number *</label>
                            <input name="accreditationNumber" type="text" placeholder="e.g. ACC1000" className="w-full px-4 py-2 border border-gray-300 rounded focus:ring-2 focus:ring-primary focus:outline-none" />
                            <FieldError field="accreditationNumber" />
                            <p className="text-xs text-gray-400 mt-1">Must strictly be unique and valid across provider records.</p>
                        </div>
                    </div>
                </div>
            </div>
