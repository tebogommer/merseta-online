  ...
  return (
    <main className="min-h-screen bg-muted p-8">
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        {/* Header Block */}
        <div className="bg-card text-card-foreground p-6 rounded-lg shadow-sm border border-border flex justify-between items-center">
            <div>
            ...
            <div className="text-right">
                <span className="block text-xs font-semibold text-muted-foreground uppercase tracking-wider mb-1">Clearance</span>
                <span className="bg-red-100 text-red-800 px-3 py-1 rounded text-xs font-bold uppercase">ADMIN ONLY</span>
            </div>
        </div>

        {/* Audit Grid Injection */}
        <Suspense fallback={<div className="p-8 text-center text-muted-foreground">Decrypting Lineage Vectors...</div>}>
