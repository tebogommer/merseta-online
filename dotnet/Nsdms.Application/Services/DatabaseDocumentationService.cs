...
END");
    ...
    private static string GetEntityDefaultDescription(string entityName) => entityName switch
    {
        ...
        "MoaTemplate" => "Master legal templates defining versioned MoA contract structures by financial year and grant policy.",
        "MoaClause" => "Reusable atomic legal clauses in the MerSETA clause library with dynamic token placeholders.",
        "MoaTemplateSection" => "Ordered section mappings associating reusable clauses with specific MoA templates.",
        "MoaExecutionSnapshot" => "Cryptographically frozen SHA-256 legal snapshots of issued MoA contracts for audit defense.",
