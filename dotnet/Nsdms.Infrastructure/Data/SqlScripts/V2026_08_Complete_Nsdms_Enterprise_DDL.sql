...
-- ==========================================================================================
-- Bulk Spreadsheet Ingestion Engine for WSP / ATR (Option C: Modern Hybrid)
-- ==========================================================================================
...
BEGIN
    ...
    CREATE NONCLUSTERED INDEX [IX_WspBulkImportStaging_BatchId_RowIndex] ON [dbo].[WspBulkImportStaging] ([BatchId], [RowIndex]);
    CREATE NONCLUSTERED INDEX [IX_WspBulkImportStaging_Batch_Validation] ON [dbo].[WspBulkImportStaging] ([BatchId], [IsValid], [IsCommitted]);
