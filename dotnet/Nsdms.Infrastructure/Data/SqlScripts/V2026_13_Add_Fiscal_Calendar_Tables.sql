-- ==============================================================================
-- V2026_13_Add_Fiscal_Calendar_Tables.sql
-- MerSETA NSDMS Enterprise Scheme: Hierarchical Relational Fiscal Calendar
-- Configurable Financial Years, Quarters & Dynamic Working Day Engine
-- ==============================================================================

SET NOCOUNT ON;

-- 1. Create FinancialYear Master Table
...
-- 2. Create FinancialQuarter Child Table
...
-- 3. Seed Default Statutory Financial Years (FY 2025/2026, 2026/2027, 2027/2028)
IF NOT EXISTS (SELECT 1 FROM [dbo].[FinancialYear] WHERE [FinYearCode] = '2026/2027')
BEGIN
    -- FY 2026/2027 (Active Current Financial Year)
...
BEGIN
    -- FY 2025/2026 (Audited Prior Year)
    INSERT INTO [dbo].[FinancialYear] ([FinYearCode], [StartYear], [EndYear], [StartDate], [EndDate], [Description], [StatusCode], [IsActive], [IsClosed], [CreatedBy])
...
BEGIN
    -- FY 2027/2028 (Upcoming Leap Year)
    INSERT INTO [dbo].[FinancialYear] ([FinYearCode], [StartYear], [EndYear], [StartDate], [EndDate], [Description], [StatusCode], [IsActive], [IsClosed], [CreatedBy])
