...
{
    [Fact]
    public void SetmisLookupBatchSeeder_LoadsAll38Categories()
    {
        // Act
        ...
        Assert.Equal(38, categories.Count);
    }
    ...
    public void SetmisLookupBatchSeeder_LoadsFullRecordCount()
    {
        ...
        // Assert: Exactly 24,927 verified SETMIS records loaded
        Assert.Equal(24927, totalRecords);
    }
    ...
    [Fact]
    public async Task LookupService_GetAllLookupMetadata_Returns50Categories()
    {
        // Arrange
