...
public class QmrCandidacyProgrammeDataDAO extends AbstractDAO  {
	...
	public List<QmrCandidacyProgrammeData> allQmrCandidacyProgrammeData() throws Exception {
		return (List<QmrCandidacyProgrammeData>)super.getList("select o from QmrCandidacyProgrammeData o");
	}

	/**
	 * Get all QmrCandidacyProgrammeData between from and noRows
 	 * @author TechFinium 
 	 * @param from the from
 	 ...
 	 */
	@SuppressWarnings("unchecked")
	public List<QmrCandidacyProgrammeData> allQmrCandidacyProgrammeData(Long from, int noRows) throws Exception {
	 	String hql = "select o from QmrCandidacyProgrammeData o " ;
	    Map<String, Object> parameters = new Hashtable<String, Object>();
	    
		return (List<QmrCandidacyProgrammeData>)super.getList(hql, parameters,from.intValue(),noRows);
	}
	...
	public QmrCandidacyProgrammeData findByKey(Long id) throws Exception {
	 	String hql = "select o from QmrCandidacyProgrammeData o where o.id = :id " ;
	    Map<String, Object> parameters = new Hashtable<String, Object>();
	    parameters.put("id", id);
		return (QmrCandidacyProgrammeData)super.getUniqueResult(hql, parameters);
	}
	 ...
	 * Find QmrCandidacyProgrammeData by description
 	 ...
 	 */
	@SuppressWarnings("unchecked")
	public List<QmrCandidacyProgrammeData> findByName(String description) throws Exception {
	 	String hql = "select o from QmrCandidacyProgrammeData o where o.description like  :description order by o.desc " ;
	    Map<String, Object> parameters = new Hashtable<String, Object>();
	    parameters.put("description", ""+description.trim()+"%");
		return (List<QmrCandidacyProgrammeData>)super.getList(hql, parameters);
	}
	 ...
	 */
	@SuppressWarnings("unchecked")
	public List<QmrCandidacyProgrammeData> findDataForReport(Long qmrFinYearId, List<EmploymentStatusEnum> employmentStatusEnum, QmrEnteredCompletedEnum qmrEnteredCompletedEnum) throws Exception {
	 	String hql = "select o from QmrCandidacyProgrammeData o where o.qmrFinYears.id = :qmrFinYearId " ;
	...
	public Integer findDataForReportCount(Long qmrFinYearId, List<EmploymentStatusEnum> employmentStatusEnum, QmrEnteredCompletedEnum qmrEnteredCompletedEnum) throws Exception {
	 	String hql = "select count(o) from QmrCandidacyProgrammeData o where o.qmrFinYears.id = :qmrFinYearId " ;
	    Map<String, Object> parameters = new HashMap<>();
	    parameters.put("qmrFinYearId", qmrFinYearId);
	    if (employmentStatusEnum != null && !employmentStatusEnum.isEmpty()) {
			hql +=" and o.employedUnEmployed in ( ";
	...
	public Integer countByDisabilityIdentified(Long qmrFinYearId, EmploymentStatusEnum employedUnEmployed, QmrEnteredCompletedEnum qmrEnteredCompletedEnum, Boolean disabilityIdentifiedValue) throws Exception {
	 	String hql = "select count(o) from QmrCandidacyProgrammeData o where o.qmrFinYears.id = :qmrFinYearId and o.qmrEnteredCompleted = :qmrEnteredCompletedEnum and o.employedUnEmployed = :employedUnEmployed "
	...
	public Integer countByDisabilityIdentified(Long qmrFinYearId, QmrEnteredCompletedEnum qmrEnteredCompletedEnum, Boolean disabilityIdentifiedValue) throws Exception {
	 	String hql = "select count(o) from QmrCandidacyProgrammeData o where o.qmrFinYears.id = :qmrFinYearId and o.qmrEnteredCompleted = :qmrEnteredCompletedEnum "
	 			+ " and o.disabilityIdentified = :disabilityIdentifiedValue" ;
	    Map<String, Object> parameters = new HashMap<>();
	    parameters.put("qmrFinYearId", qmrFinYearId);
	    parameters.put("qmrEnteredCompletedEnum", qmrEnteredCompletedEnum);
