...
public class QmrSkillsProgrammeDataDAO extends AbstractDAO  {
	...
	public List<QmrSkillsProgrammeData> allQmrSkillsProgrammeData() throws Exception {
		return (List<QmrSkillsProgrammeData>)super.getList("select o from QmrSkillsProgrammeData o");
	}

	/**
	 * Get all QmrSkillsProgrammeData between from and noRows
 	 * @author TechFinium 
 	 * @param from the from
 	 ...
 	 */
	@SuppressWarnings("unchecked")
	public List<QmrSkillsProgrammeData> allQmrSkillsProgrammeData(Long from, int noRows) throws Exception {
	 	String hql = "select o from QmrSkillsProgrammeData o " ;
	    Map<String, Object> parameters = new Hashtable<String, Object>();
	    
		return (List<QmrSkillsProgrammeData>)super.getList(hql, parameters,from.intValue(),noRows);
	}
	...
	public QmrSkillsProgrammeData findByKey(Long id) throws Exception {
	 	String hql = "select o from QmrSkillsProgrammeData o where o.id = :id " ;
	    Map<String, Object> parameters = new Hashtable<String, Object>();
	    parameters.put("id", id);
		return (QmrSkillsProgrammeData)super.getUniqueResult(hql, parameters);
	}
	 ...
	 * Find QmrSkillsProgrammeData by description
 	 ...
 	 */
	@SuppressWarnings("unchecked")
	public List<QmrSkillsProgrammeData> findByName(String description) throws Exception {
	 	String hql = "select o from QmrSkillsProgrammeData o where o.description like  :description order by o.desc " ;
	    Map<String, Object> parameters = new Hashtable<String, Object>();
	    parameters.put("description", ""+description.trim()+"%");
		return (List<QmrSkillsProgrammeData>)super.getList(hql, parameters);
	}
	 ...
	 */
	@SuppressWarnings("unchecked")
	public List<QmrSkillsProgrammeData> findDataForReport(Long qmrFinYearId, List<EmploymentStatusEnum> employmentStatusEnum, QmrEnteredCompletedEnum qmrEnteredCompletedEnum) throws Exception {
	 	String hql = "select o from QmrSkillsProgrammeData o where o.qmrFinYears.id = :qmrFinYearId " ;
	...
	public Integer findDataForReportCount(Long qmrFinYearId, List<EmploymentStatusEnum> employmentStatusEnum, QmrEnteredCompletedEnum qmrEnteredCompletedEnum) throws Exception {
	 	String hql = "select count(o) from QmrSkillsProgrammeData o where o.qmrFinYears.id = :qmrFinYearId " ;
	    Map<String, Object> parameters = new HashMap<>();
	    parameters.put("qmrFinYearId", qmrFinYearId);
	    if (employmentStatusEnum != null && !employmentStatusEnum.isEmpty()) {
			hql +=" and o.employedUnEmployed in ( ";
	...
	public Integer countByDisabilityIdentified(Long qmrFinYearId, EmploymentStatusEnum employedUnEmployed, QmrEnteredCompletedEnum qmrEnteredCompletedEnum, Boolean disabilityIdentifiedValue) throws Exception {
	 	String hql = "select count(o) from QmrSkillsProgrammeData o where o.qmrFinYears.id = :qmrFinYearId and o.qmrEnteredCompleted = :qmrEnteredCompletedEnum and o.employedUnEmployed = :employedUnEmployed "
