...
public class QmrArtisanDataDAO extends AbstractDAO  {
	...
	public List<QmrArtisanData> allQmrArtisanData() throws Exception {
		return (List<QmrArtisanData>)super.getList("select o from QmrArtisanData o");
	}

	/**
	 * Get all QmrArtisanData between from and noRows
 	 * @author TechFinium 
 	 * @param from the from
 	 ...
 	 */
	@SuppressWarnings("unchecked")
	public List<QmrArtisanData> allQmrArtisanData(Long from, int noRows) throws Exception {
	 	String hql = "select o from QmrArtisanData o " ;
	    Map<String, Object> parameters = new Hashtable<String, Object>();
	    
		return (List<QmrArtisanData>)super.getList(hql, parameters,from.intValue(),noRows);
	}
	...
	public QmrArtisanData findByKey(Long id) throws Exception {
	 	String hql = "select o from QmrArtisanData o where o.id = :id " ;
	    Map<String, Object> parameters = new Hashtable<String, Object>();
	    parameters.put("id", id);
		return (QmrArtisanData)super.getUniqueResult(hql, parameters);
	}	/**
	 * Find QmrArtisanData by description
 	 ...
 	 */
	@SuppressWarnings("unchecked")
	public List<QmrArtisanData> findByName(String description) throws Exception {
	 	String hql = "select o from QmrArtisanData o where o.description like  :description order by o.desc " ;
	    Map<String, Object> parameters = new Hashtable<String, Object>();
	    parameters.put("description", ""+description.trim()+"%");
		return (List<QmrArtisanData>)super.getList(hql, parameters);
	}
	 ...
	 */
	@SuppressWarnings("unchecked")
	public List<QmrArtisanData> findDataForReport(Long qmrFinYearId, List<EmploymentStatusEnum> employmentStatusEnum, QmrEnteredCompletedEnum qmrEnteredCompletedEnum) throws Exception {
	 	String hql = "select o from QmrArtisanData o where o.qmrFinYears.id = :qmrFinYearId " ;
	...
	public Integer findDataForReportCount(Long qmrFinYearId, List<EmploymentStatusEnum> employmentStatusEnum, QmrEnteredCompletedEnum qmrEnteredCompletedEnum) throws Exception {
	 	String hql = "select count(o) from QmrArtisanData o where o.qmrFinYears.id = :qmrFinYearId " ;
	    Map<String, Object> parameters = new HashMap<>();
	    parameters.put("qmrFinYearId", qmrFinYearId);
	    if (employmentStatusEnum != null && !employmentStatusEnum.isEmpty()) {
			hql +=" and o.employedUnEmployed in ( ";
	...
	public Integer countByDisabilityIdentified(Long qmrFinYearId, EmploymentStatusEnum employedUnEmployed, QmrEnteredCompletedEnum qmrEnteredCompletedEnum, Boolean disabilityIdentifiedValue) throws Exception {
	 	String hql = "select count(o) from QmrArtisanData o where o.qmrFinYears.id = :qmrFinYearId and o.qmrEnteredCompleted = :qmrEnteredCompletedEnum and o.employedUnEmployed = :employedUnEmployed "
	...
	public Integer countByDisabilityIdentified(Long qmrFinYearId,  QmrEnteredCompletedEnum qmrEnteredCompletedEnum, Boolean disabilityIdentifiedValue) throws Exception {
	 	String hql = "select count(o) from QmrArtisanData o where o.qmrFinYears.id = :qmrFinYearId and o.qmrEnteredCompleted = :qmrEnteredCompletedEnum  "
	 			+ " and o.disabilityIdentified = :disabilityIdentifiedValue" ;
	    Map<String, Object> parameters = new HashMap<>();
	    parameters.put("qmrFinYearId", qmrFinYearId);
	    parameters.put("qmrEnteredCompletedEnum", qmrEnteredCompletedEnum);
