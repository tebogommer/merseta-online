...
@ManagedBean(name = "activecontractdetailUI")
@ViewScoped
public class ActiveContractDetailUI extends AbstractUI {
	...
	public void activecontractdetailInsert() {
		try {
			...
			service.requesteWorkflow(activecontractdetail, getSessionUI().getActiveUser());
			prepareNew();
	...
	public void completeWorkflow() {
		try {
			service.completeWorkflowVerionTwo(activecontractdetail, getSessionUI().getActiveUser(), getSessionUI().getTask());
