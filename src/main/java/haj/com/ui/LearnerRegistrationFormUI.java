...
@ManagedBean(name = "learnerRegistrationFormUI")
@ViewScoped
public class LearnerRegistrationFormUI extends AbstractUI {
	...
	private void runInit() throws Exception {
		...
		if (super.getParameter("id", false) != null) {
			...
			if (getSessionUI().getTask() != null && getSessionUI().getTask().getWorkflowProcess() == ConfigDocProcessEnum.LearnerTransfer) {
				...
				// companyLearnersService.prepareNewRegistration(ConfigDocProcessEnum.LearnerTransfer,
				// companyLearnersTransfer.getCompanyLearners());
				if (companyLearnersTransfer.getLearnerTransferApproval() != LearnerTransferApproval.NormalWorkflow) {
					//this.companyLearnersTransfer.setDocs(new ArrayList<>());
				}
				// Loading Learner Registration Docs
				...
				// Learner Registration Docs
				companyLearnersService.prepareNewRegistration(companyLearnersTransfer.getCompanyLearners());
				// Workflow Documents
				companyLearnersService.prepareTransferDocumentByProcess(configForRejectReasons, companyLearnersTransfer, getSessionUI().getTask().getProcessRole());

				locateIfRejectReasonsAssigned(companyLearnersTransfer.getClass().getName(), companyLearnersTransfer.getId());
				// populateExistingLearner();
			}else if (getSessionUI().getTask() != null && getSessionUI().getTask().getWorkflowProcess() == ConfigDocProcessEnum.ELearnerTransfer) {
				getSessionUI().setTask(TasksService.instance().findByKey(getSessionUI().getTask().getId()));
				this.companyLearnersTransfer = companyLearnersService.findTransferByKey(getSessionUI().getTask().getTargetKey(), ConfigDocProcessEnum.LearnerTransfer);
				// companyLearnersService.prepareNewRegistration(ConfigDocProcessEnum.LearnerTransfer,
				// companyLearnersTransfer.getCompanyLearners());
				...
				signOffs = signoffService.findByTargetKeyAndClass(companyLearnersTransfer.getId(), companyLearnersTransfer.getClass().getName());
				// Loading Learner Registration Docs
				//companyLearnersService.prepareNewRegistration(ConfigDocProcessEnum.LearnerTransfer, companyLearnersTransfer.getCompanyLearners());
				// Learner Registration Docs
				companyLearnersService.prepareNewRegistration(companyLearnersTransfer.getCompanyLearners());
				...
				locateIfRejectReasonsAssigned(companyLearnersTransfer.getClass().getName(), companyLearnersTransfer.getId());
				// populateExistingLearner();
			}  else if (getSessionUI().getTask() != null && getSessionUI().getTask().getWorkflowProcess() == ConfigDocProcessEnum.LearnerTransferSiteVisit) {
				getSessionUI().setTask(TasksService.instance().findByKey(getSessionUI().getTask().getId()));
				this.companyLearnersTransfer = companyLearnersService.findTransferByKey(getSessionUI().getTask().getTargetKey(), ConfigDocProcessEnum.LearnerTransferSiteVisit);
				// companyLearnersService.prepareNewRegistration(ConfigDocProcessEnum.LearnerTransfer,
				// companyLearnersTransfer.getCompanyLearners());
				if (companyLearnersTransfer.getLearnerTransferApproval() != LearnerTransferApproval.NormalWorkflow) {
					this.companyLearnersTransfer.setDocs(new ArrayList<>());
				...
				//companyLearnersService.prepareNewRegistration(ConfigDocProcessEnum.LearnerTransfer, companyLearnersTransfer.getCompanyLearners());
				// Learner Registration Docs
				//companyLearnersService.prepareNewRegistration(ConfigDocProcessEnum.Learner, companyLearnersTransfer.getCompanyLearners());
				companyLearnersService.prepareNewRegistration(companyLearnersTransfer.getCompanyLearners());
				// Workflow Documents
				companyLearnersService.prepareTransferDocumentByProcess(configForRejectReasons, companyLearnersTransfer, getSessionUI().getTask().getProcessRole());
				locateIfRejectReasonsAssigned(companyLearnersTransfer.getClass().getName(), companyLearnersTransfer.getId());
			...
			} else if (getSessionUI().getTask() != null && getSessionUI().getTask().getWorkflowProcess() == ConfigDocProcessEnum.Learner) {
				getSessionUI().setTask(TasksService.instance().findByKey(getSessionUI().getTask().getId()));
				this.companylearners = companyLearnersService.findByKey(getSessionUI().getTask().getTargetKey(), ConfigDocProcessEnum.Learner);
				companyLearnersService.prepareNewRegistrationDocs(ConfigDocProcessEnum.Learner, companylearners, getSessionUI().getTask());
				//companyLearnersService.prepareNewRegistration(ConfigDocProcessEnum.Learner, companylearners, getSessionUI().getTask());
				...
				if (companylearners.getStatus() == ApprovalEnum.RejectedByLearnerReview || companylearners.getStatus() == ApprovalEnum.Rejected) {
			...
			} else if (getSessionUI().getTask() != null && getSessionUI().getTask().getWorkflowProcess() == ConfigDocProcessEnum.LearnerRegistration) {
				getSessionUI().setTask(TasksService.instance().findByKey(getSessionUI().getTask().getId()));
				this.companylearners = companyLearnersService.findByKey(getSessionUI().getTask().getTargetKey(), ConfigDocProcessEnum.LearnerRegistration);
				companyLearnersService.prepareNewRegistration(ConfigDocProcessEnum.LearnerRegistration, companylearners, getSessionUI().getTask());
				// companyLearnersService.prepareNewCompanyLearnersRegistration(getSessionUI().getTask().getWorkflowProcess(),
				// companylearners, getSessionUI().getTask().getProcessRole());
				if (companylearners.getAppointment() != null) {
					appointment = companylearners.getAppointment();
				...
				if(getSessionUI().getTask().getFirstInProcess() && companylearners.getStatus() == ApprovalEnum.Rejected) {
					disableFields = false;
				}
				...
				companyLearnersService.prepareNewRegistration(ConfigDocProcessEnum.UnemployedBursaryLearnerRegistration, companylearners);
				// companyLearnersService.prepareNewCompanyLearnersRegistration(getSessionUI().getTask().getWorkflowProcess(),
				// companylearners, getSessionUI().getTask().getProcessRole());
				if (companylearners.getAppointment() != null) {
					appointment = companylearners.getAppointment();
			...
			}else if (getSessionUI().getTask() != null && getSessionUI().getTask().getWorkflowProcess() == ConfigDocProcessEnum.LearnerReview) {
				getSessionUI().setTask(TasksService.instance().findByKey(getSessionUI().getTask().getId()));
				this.companylearners = companyLearnersService.findByKey(getSessionUI().getTask().getTargetKey(), ConfigDocProcessEnum.LearnerReview);
				// companyLearnersService.prepareNewRegistration(getSessionUI().getTask().getWorkflowProcess(),
				// companylearners, getSessionUI().getTask().getProcessRole());
				...
				populateExistingLearner();
			} else if (getSessionUI().getTask() != null && getSessionUI().getTask().getWorkflowProcess() == ConfigDocProcessEnum.CompanyLearner) {
				getSessionUI().setTask(TasksService.instance().findByKey(getSessionUI().getTask().getId()));
				...
				List<Doc> docList = DocService.instance().searchByTargetKeyAndClass(this.companylearners.getClass().getName(), this.companylearners.getId(), ConfigDocProcessEnum.Learner);
				companylearners.getDocs().addAll(docList);
				// this.companylearners.setDocs(DocService.instance().searchByTargetKeyAndClass(this.companylearners.getClass().getName(),
				// this.companylearners.getId(), ConfigDocProcessEnum.Learner));
				// populateRejectReasons();
				...
				usersDisabilityList = usersDisabilityService.findByKeyUser(companylearners.getUser());
				populateExistingLearner();
			} else if (getSessionUI().getTask() != null && getSessionUI().getTask().getWorkflowProcess() == ConfigDocProcessEnum.LearnerFileManagement) {
				getSessionUI().setTask(TasksService.instance().findByKey(getSessionUI().getTask().getId()));
				this.companylearners = companyLearnersService.findByKey(getSessionUI().getTask().getTargetKey(), ConfigDocProcessEnum.LearnerFileManagement);
				// this.companylearners.setDocs(DocService.instance().searchByTargetKeyAndClass(this.companylearners.getClass().getName(),
				// this.companylearners.getId(), ConfigDocProcessEnum.Learner));

				this.companylearners.setDocs(DocService.instance().searchByTargetKeyAndClass(this.companylearners.getClass().getName(), this.companylearners.getId()));
				...
				usersDisabilityList = usersDisabilityService.findByKeyUser(companylearners.getUser());
				populateExistingLearner();
				if (companylearners.getFileApprovalEnum() == ApprovalEnum.Rejected) {
					populateRejectReasons();
				}
			}else if (getSessionUI().getTask() != null && getSessionUI().getTask().getWorkflowProcess() == ConfigDocProcessEnum.LearnerRegistrationDocuments) {
				getSessionUI().setTask(TasksService.instance().findByKey(getSessionUI().getTask().getId()));
				this.companylearners = companyLearnersService.findByKey(getSessionUI().getTask().getTargetKey(), ConfigDocProcessEnum.LearnerRegistrationDocuments);
				...
				if (companylearners.getDocumentChangeStatus() == ApprovalEnum.Rejected) {
					populateRejectReasons();
				}
				populateDateChangeReason();
				if (companylearners.getHostCompany() != null && companylearners.getHostCompany().getId() != null) {
					this.hostCompany = companyService.findByKey(companylearners.getHostCompany().getId());
					prepareHostCompanyAfterSearch();
					companylearners.setHostCompany(hostCompany);
			...
			disableFields = false;
			searchSetObject();
			if (super.getParameter("selectedTrainingProviderId", true) != null) {
				this.trainingProviderApplication=TrainingProviderApplicationService.instance().findByKey((Long) super.getParameter("selectedTrainingProviderId", true));
				this.companylearners.setTrainingProviderApplication(trainingProviderApplication);
				this.trainingProvider = this.trainingProviderApplication.getCompany();
				this.companylearners.setCompany(this.trainingProviderApplication.getCompany());
				if (companyService == null) {
					companyService = new CompanyService();
				}
				companyService.resolveCompanyAddresses(trainingProvider);
				//this.companylearners.setTrainingProviderApplication(this.trainingProviderApplication);
			...
			} else if (super.getParameter("employerId", true) != null) {
				isTrainingProviderApplication = false;
				this.trainingProvider = companyService.findByKey((Long) super.getParameter("employerId", true));
				if (companyService == null) {
					companyService = new CompanyService();
				}
				companyService.resolveCompanyAddresses(trainingProvider);
				...
				/*
				 * this.company = companyService.findByKey((Long)
				 * super.getParameter("employerId", true)); if (company != null &&
				 * company.getId() != null) { setsearchComplete(); }
				 */
			}

			if (super.getParameter("companyLearnersId", true) != null) {
			...
			} else if (super.getParameter("userId", false) != null) {
	...
	private void populateDateChangeReason() throws Exception {
		dateChangeReasonAvalibleSelectionList = DateChangeReasonsService.instance().locateReasonsSelectedByTargetKeyClassAndProcess(companylearners.getId(), companylearners.getClass().getName(), getSessionUI().getTask().getWorkflowProcess());
	}
	...
	private void populateExistingLearner() throws Exception {
		...
		if(this.user.getLegalGaurdian() != null) {
			if(this.user.getLegalGaurdian().getResidentialAddress() != null) {
				legalGaurdianResidentialAddress = AddressService.instance().findByKey(this.user.getLegalGaurdian().getResidentialAddress().getId());
	...
	private void locateIfRejectReasonsAssigned(String targetClass, Long targetKey) throws Exception {
		RejectReasonsService rejectService = new RejectReasonsService();
		long                 count         = rejectService.countReasonsSelectedByTargetKeyClassAndProcess(targetKey, targetClass, configForRejectReasons);
		if (count != 0) {
	...
	public List<RejectReasons> getRejectionReasonsLearnerTransfer() {
		RejectReasonsService rejectReasonsService = new RejectReasonsService();
		List<RejectReasons>  l                    = null;
		try {
			l = rejectReasonsService.locateReasonsSelectedByTargetKeyClassAndProcess(companyLearnersTransfer.getId(), companyLearnersTransfer.getClass().getName(), ConfigDocProcessEnum.LearnerTransfer);
		} catch (Exception e) {
			e.printStackTrace();
			addErrorMessage(e.getMessage(), e);
		}
	...
	public void completeCompanyLearnersToFinalApproval() {
		try {
			companyLearnersService.completeCompanyLearnersToFinalApproval(companylearners, getSessionUI().getActiveUser(), getSessionUI().getTask());
			getSessionUI().setTask(null);
			ajaxRedirectToDashboard();
		} catch (Exception e) {
			addErrorMessage(e.getMessage(), e);
	...
	public void completeCompanyLearnersForReview() {

		try {
			companyLearnersService.completeCompanyLearnersForReview(companylearners, getSessionUI().getActiveUser(), getSessionUI().getTask());
			getSessionUI().setTask(null);
			ajaxRedirectToDashboard();
		} catch (Exception e) {
			addWarningMessage(super.getEntryLanguage("could.not.save"));
	...
	public void finalApproveWorkflow() {
		try {
			...
			companyLearnersService.finalApproveWorkflow(companylearners, getSessionUI().getActiveUser(), getSessionUI().getTask());
			getSessionUI().setTask(null);
			ajaxRedirectToDashboard();
		} catch (Exception e) {
			e.printStackTrace();
	...
	public void finalApproveDocuments() {
		try {
			/*if (signoff == false) {
				throw new Exception("Please signoff before proceeding");
			}*/
			companyLearnersService.finalApproveDocuments(companylearners, getSessionUI().getActiveUser(), getSessionUI().getTask());
			getSessionUI().setTask(null);
			ajaxRedirectToDashboard();
		} catch (Exception e) {
			e.printStackTrace();
	...
	public void uploadSignedDocument() {
		try {
			companyLearnersService.uploadSignedDocument(companylearners, getSessionUI().getActiveUser(), getSessionUI().getTask());
			getSessionUI().setTask(null);
			ajaxRedirectToDashboard();
		} catch (Exception e) {
			e.printStackTrace();
	...
	public void uploadChangeDocuments() {
		try {
			companyLearnersService.uploadChangeDocuments(companylearners, getSessionUI().getActiveUser(), getSessionUI().getTask());
			getSessionUI().setTask(null);
			ajaxRedirectToDashboard();
		} catch (Exception e) {
			e.printStackTrace();
	...
	public void clearCurrentLearner() {
		...
		learningProgramme = new Qualification();
	...
	private void startLearnerReg(boolean sendWorkflow) throws Exception {
		...
		/*if (this.interventionType.getWorkplaceApprovalRequired() != null && this.interventionType.getWorkplaceApprovalRequired() && qualification != null && qualification.getWorkplaceApprovalRequired() != null && qualification.getWorkplaceApprovalRequired()) {
			if (!companyLearnersService.checkSmeQualificationMentor(qualification, company)) {
				throw new Exception("Number of learners have exceeded the learner-mentor ratio");
			}
		}*/
		
		if(this.trainingProviderApplication != null) {
			companylearners.setTrainingProviderApplication(trainingProviderApplication);
			companylearners.setCompany(trainingProviderApplication.getCompany());
		}
		...
		companyLearnersService.createNewLearner(getSessionUI().getActiveUser(), this.user, companylearners, sendWorkflow, requireGaurdian, usersLanguageList, usersDisabilityList);
		//companyLearnersService.createLearner(getSessionUI().getActiveUser(), this.user, company, trainingProvider, companylearners, sendWorkflow, requireGaurdian, usersLanguageList, usersDisabilityList);
	...
	public void submitLearnerTransfer() {
		try {
			companyLearnersService.submitLearnerTransfer(companyLearnersTransfer, getSessionUI().getActiveUser(), getSessionUI().getTask());
			companyLearnersService.setRejectedReasons(companyLearnersTransfer.getClass().getName(), companyLearnersTransfer.getId(), getSessionUI().getActiveUser(), new ArrayList<>(), configForRejectReasons);
			getSessionUI().setTask(null);
			ajaxRedirectToDashboard();
		} catch (Exception e) {
			e.printStackTrace();
	...
	public void uploadLearnerTransferDocuments() {
		try {
			companyLearnersService.uploadLearnerTransferDocuments(companyLearnersTransfer, getSessionUI().getActiveUser(), getSessionUI().getTask());
			companyLearnersService.setRejectedReasons(companyLearnersTransfer.getClass().getName(), companyLearnersTransfer.getId(), getSessionUI().getActiveUser(), new ArrayList<>(), configForRejectReasons);
			getSessionUI().setTask(null);
			ajaxRedirectToDashboard();
		} catch (Exception e) {
	...
	public void eLearnerTransferCompleteTask() {
		try {
			if(signOff == null) {
			...
			companyLearnersService.eLearnerTransferCompleteTask(companyLearnersTransfer, getSessionUI().getActiveUser(), getSessionUI().getTask());
			companyLearnersService.setRejectedReasons(companyLearnersTransfer.getClass().getName(), companyLearnersTransfer.getId(), getSessionUI().getActiveUser(), new ArrayList<>(), configForRejectReasons);
			getSessionUI().setTask(null);
			ajaxRedirectToDashboard();
		} catch (Exception e) {
	...
	public void withdrawTransfer() {
		try {
			companyLearnersService.withdrawTransfer(companyLearnersTransfer, getSessionUI().getActiveUser(), getSessionUI().getTask());
			companyLearnersService.setRejectedReasons(companyLearnersTransfer.getClass().getName(), companyLearnersTransfer.getId(), getSessionUI().getActiveUser(), new ArrayList<>(), configForRejectReasons);
			getSessionUI().setTask(null);
			ajaxRedirectToDashboard();
		} catch (Exception e) {
	...
	public void completeLearnerTransferSiteVisit() {
		try {
			if (getSessionUI().getTask().getProcessRole().getRolePermission() != UserPermissionEnum.Edit) {
				validateSiteVisit();
			}
			companyLearnersService.completeLearnerTransferSiteVisit(companyLearnersTransfer, getSessionUI().getActiveUser(), getSessionUI().getTask());
			getSessionUI().setTask(null);
			ajaxRedirectToDashboard();
		} catch (Exception e) {
			e.printStackTrace();
	...
	public boolean validateSiteVisit() throws Exception {
		boolean show = false;
		try {
			SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");

			String strDate1 = sdf.format(companyLearnersTransfer.getSiteVisitDate());
			...
			if (meetingDate.after(currentDate)) {
				throw new Exception("You can not action this task before the site visit date");
			}
	...
	public void rejectlearnerTransfer() throws Exception {
		try {
			if (selectedRejectReason.size() == 0) {
				throw new Exception("Select One Reason For Rejection Before Proceeding");
			}
			companyLearnersService.rejectlearnerTransfer(companyLearnersTransfer, getSessionUI().getActiveUser(), getSessionUI().getTask());
			companyLearnersService.setRejectedReasons(companyLearnersTransfer.getClass().getName(), companyLearnersTransfer.getId(), getSessionUI().getActiveUser(), selectedRejectReason, configForRejectReasons);
			getSessionUI().setTask(null);
			ajaxRedirectToDashboard();
		} catch (Exception e) {
			e.printStackTrace();
	...
	public void rejectlearnerTransferFinal() throws Exception {
		try {
			if (selectedRejectReason.size() == 0) {
				throw new Exception("Select One Reason For Rejection Before Proceeding");
			}
			companyLearnersService.rejectlearnerTransferFinal(companyLearnersTransfer, getSessionUI().getActiveUser(), getSessionUI().getTask(), selectedRejectReason);
			//companyLearnersService.setRejectedReasons(companyLearnersTransfer.getClass().getName(), companyLearnersTransfer.getId(), getSessionUI().getActiveUser(), selectedRejectReason, configForRejectReasons);
			getSessionUI().setTask(null);
			ajaxRedirectToDashboard();
		} catch (Exception e) {
	...
	public void companyApproveCompanyLearnersTransfer() throws Exception {
		try {
			companyLearnersService.companyApproval(companyLearnersTransfer, getSessionUI().getActiveUser(), getSessionUI().getTask());
			getSessionUI().setTask(null);
			ajaxRedirectToDashboard();
		} catch (Exception e) {
			e.printStackTrace();
	...
	public void companyRejectCompanyLearnersTransfer() throws Exception {
		try {
			companyLearnersService.companyRejection(companyLearnersTransfer, getSessionUI().getActiveUser(), getSessionUI().getTask());
			getSessionUI().setTask(null);
			ajaxRedirectToDashboard();
		} catch (Exception e) {
			e.printStackTrace();
	...
	public void learnerApproveLearnersTransfer() throws Exception {
		try {
			companyLearnersService.learnerApproval(companyLearnersTransfer, getSessionUI().getActiveUser(), getSessionUI().getTask());
			getSessionUI().setTask(null);
			ajaxRedirectToDashboard();
		} catch (Exception e) {
			e.printStackTrace();
	...
	public void learnerRejectLearnersTransfer() throws Exception {
		try {
			companyLearnersService.learnerRejection(companyLearnersTransfer, getSessionUI().getActiveUser(), getSessionUI().getTask());
			getSessionUI().setTask(null);
			ajaxRedirectToDashboard();
		} catch (Exception e) {
			e.printStackTrace();
	...
	public void completeCompanyLearners() {
		try {
			...
			companyLearnersService.completeCompanyLearners(companylearners, getSessionUI().getActiveUser(), getSessionUI().getTask(), appointment);
			getSessionUI().setTask(null);
			ajaxRedirectToDashboard();
		} catch (Exception e) {
	...
	public void completeCompanyLearnersNew() {
		try {
			companyLearnersService.completeCompanyLearnersNew(companylearners, getSessionUI().getActiveUser(), getSessionUI().getTask(), appointment);
			getSessionUI().setTask(null);
			ajaxRedirectToDashboard();
		} catch (Exception e) {
			e.printStackTrace();
	...
	public void rejectCompanyLearnerDocuments() {
		try {
			if (selectedRejectReason.size() == 0) throw new Exception("Please select a reject reason");
			companyLearnersService.rejectCompanyLearnerDocuments(companylearners, getSessionUI().getActiveUser(), getSessionUI().getTask(), selectedRejectReason);
			ajaxRedirectToDashboard();
		} catch (Exception e) {
			e.printStackTrace();
			addErrorMessage(e.getMessage(), e);
	...
	private void populateRejectReasons() {
		...
		try {
			if (getSessionUI().getTask().getWorkflowProcess() == ConfigDocProcessEnum.Learner) {
				...
				rejectReason = rs.locateReasonsSelectedByTargetKeyClassAndProcess(companylearners.getId(), CompanyLearners.class.getName(), ConfigDocProcessEnum.LearnerFileManagement);
			}else if (getSessionUI().getTask().getWorkflowProcess() == ConfigDocProcessEnum.LearnerRegistration) {
				rejectReason = rs.locateReasonsSelectedByTargetKeyClassAndProcess(companylearners.getId(), CompanyLearners.class.getName(), ConfigDocProcessEnum.Learner);
			}else if (getSessionUI().getTask().getWorkflowProcess() == ConfigDocProcessEnum.UnemployedBursaryLearnerRegistration) {
				rejectReason = rs.locateReasonsSelectedByTargetKeyClassAndProcess(companylearners.getId(), CompanyLearners.class.getName(), ConfigDocProcessEnum.Learner);
			}else if (getSessionUI().getTask().getWorkflowProcess() == ConfigDocProcessEnum.LearnerRegistrationDocuments) {
				rejectReason = rs.locateReasonsSelectedByTargetKeyClassAndProcess(companylearners.getId(), CompanyLearners.class.getName(), ConfigDocProcessEnum.LearnerRegistrationDocuments);
			}
		} catch (Exception e) {
			e.printStackTrace();
			addErrorMessage(e.getMessage(), e);
	...
	public void saveTrainingProvider() {
		try {
			...
			} else companyService.update(this.trainingProvider);
	...
	public void removeQualification() {
		try {
			...
			if (this.usersQualification.getId() != null) usersQualificationService.delete(this.usersQualification);
			this.usersQualification = new UserQualifications();
	...
	public List<ProjectImplementationPlan> getSelectedProjectImplementationPlan() {
		...
		try {
			...
			// l =
			// projectImplementationPlanService.findByCompanyAndInterventionTypeAndStatus(company,
			// interventionType, ApprovalEnum.Approved);
		} catch (Exception e) {
			e.printStackTrace();
			addErrorMessage(e.getMessage(), e);
		}
	...
	/*private void pupulateUserByEmployee() throws Exception {
		EmployeesService employeesService = new EmployeesService();
		Employees        employee         = employeesService.findEmployeeByIdAndCompany(this.user, this.company);
		if (employee != null) {
			if (this.user.getId() == null) {
				...
				this.companylearners.setEmploymentType(employee.getEmploymentType());
			} else {
				...
				if (cl != null) {
					...
					this.companylearners.setOfoCodes(cl.getOfoCodes());
					if (cl.getEmploymentType() != null) {
						this.companylearners.setEmploymentType(cl.getEmploymentType());
					}
					if (cl.getEmploymentContractStartDate() != null) {
						this.companylearners.setEmploymentContractStartDate(cl.getEmploymentContractStartDate());
					}
					if (cl.getEmploymentContractEndDate() != null) {
						this.companylearners.setEmploymentContractEndDate(cl.getEmploymentContractEndDate());
					}
					this.companylearners.setEmploymentStatus(EmploymentStatusEnum.Employed);
			...
			// clearCurrentLearner();
			this.user = null;
			throw new Exception("You Can Only Register Learners Who Are Employees For " + this.company.getCompanyName());
		}
	}*/
	...
	public void prepareUserAfterSearch() throws Exception {
		if(companylearners.getInterventionType().getId() == HAJConstants.INTERVENTION_BURSARIES_UNEMPLOYED_ID) {
			...
			//companyLearnersService.prepareNewLearnershipDevelopmentRegistrationDocs(ConfigDocProcessEnum.LearnerRegistration, companylearners, companylearners, null);
			companyLearnersService.prepareLearnerRegistrationDocs(ConfigDocProcessEnum.LearnerRegistration, companylearners, companylearners, null);
			companyLearnersService.checkDocRequired(companylearners);
		}		
		resolveAddresses();
		checkRequireGaurdian();
	...
	public void continueRegistration() {
		try {
			...
			this.companylearners.setLeaningProgramme(this.learningProgramme);
	...
	public void continueLearnerRegistration() {
		try {
			...
			if(this.company.getOrganisationType() != null && this.company.getOrganisationType().getWorkplaceApprovalRequired() != null && this.company.getOrganisationType().getWorkplaceApprovalRequired() && this.interventionType.getWorkplaceApprovalRequired() != null && this.interventionType.getWorkplaceApprovalRequired() && qualification != null && qualification.getWorkplaceApprovalRequired() ) {
				...
				if(workPlaceApproval == null) {					
					...
					throw new Exception("The company selected does not have workplace approval for the selected qualification");
	...
	public void continueValidateSdpAccreditaion() throws Exception{		
		...
		System.out.println("companylearners.getInterventionType().getId():"+companylearners.getInterventionType().getId());
		if(SKILLS_PROGRAM_LIST.contains(companylearners.getInterventionType().getId())) {
			if(trainingProviderSkillsProgrammeService.countfindByCompany(trainingProvider, companylearners.getSkillsProgram(), true) > 0) {
				System.out.println("trainingProviderApplication:"+trainingProviderApplication.getId());
				showInfo = true;
				this.companylearners.setTrainingProviderApplication(trainingProviderApplication);
				this.companylearners.setCompany(trainingProviderApplication.getCompany());
				System.out.println("trainingProviderApplication.getCompany():"+trainingProviderApplication.getCompany());
			}else {
				...
				throw new Exception("Selected training provider is not accredited for the selected skill programme");
			}			
		}else if(SKILLS_SET_LIST.contains(companylearners.getInterventionType().getId())) {
			if(trainingProviderSkillsSetService.countfindByCompany(trainingProvider, companylearners.getSkillsSet(), true) > 0){
				showInfo = true;
				this.companylearners.setTrainingProviderApplication(trainingProviderApplication);
				this.companylearners.setCompany(trainingProviderApplication.getCompany());
			}else {
				...
				this.companylearners.setSkillsSet(null);
				this.companylearners.setUnitStandard(null);
				throw new Exception("Selected training provider is not accredited for the selected skill set");
			}
		}else if(companylearners.getInterventionType().getId() == HAJConstants.CREDIT_BEARING_SHORT_COURSE) {
			if(CompanyUnitStandardService.instance().countCompanyUnitStandardAccptedByTargetClassAndKey(trainingProviderApplication.getClass().getName(), trainingProviderApplication.getId(), selectedUnitStandards, true) > 0) {
				showInfo = true;
				this.companylearners.setTrainingProviderApplication(trainingProviderApplication);
				this.companylearners.setCompany(trainingProviderApplication.getCompany());
			}else {
				if(CompanyQualificationsService.instance().countfindByCompany(trainingProvider, selectedQualification, true) > 0) {
					showInfo = true;
					this.companylearners.setTrainingProviderApplication(trainingProviderApplication);
					this.companylearners.setCompany(trainingProviderApplication.getCompany());
				}else {					
					if(this.learningProgramme != null && this.learningProgramme.getId() != null &&  CompanyQualificationsService.instance().countfindByCompany(trainingProvider, this.learningProgramme, true) > 0) {
						showInfo = true;
						this.companylearners.setLeaningProgramme(this.learningProgramme);
						this.companylearners.setTrainingProviderApplication(trainingProviderApplication);
						this.companylearners.setCompany(trainingProviderApplication.getCompany());
						...
						this.companylearners.setSkillsSet(null);
						this.companylearners.setUnitStandard(null);
						throw new Exception("Selected training provider is not accredited for the selected unit standard");
					}
				}
			}
		}else if(companylearners.getInterventionType().getInterventionTypeEnum() == InterventionTypeEnum.Learnership) {
			if(CompanyQualificationsService.instance().countfindByTrainingProviderApplication(trainingProviderApplication, companylearners.getLearnership().getQualification(), true)  > 0) {
				showInfo = true;
				this.companylearners.setTrainingProviderApplication(trainingProviderApplication);
				this.companylearners.setCompany(trainingProviderApplication.getCompany());
			}else {
				...
				this.companylearners.setSkillsSet(null);
				this.companylearners.setUnitStandard(null);
				throw new Exception("Selected training provider is not accredited for the selected learnership");
			}
		}else if(companylearners.getInterventionType().getInterventionTypeEnum() == InterventionTypeEnum.Apprenticeship) {
			System.out.println("CompanyQualificationsService.instance().countfindByTrainingProviderApplication(trainingProviderApplication, companylearners.getQualification() , true )::"+CompanyQualificationsService.instance().countfindByTrainingProviderApplication(trainingProviderApplication, companylearners.getQualification() , true ));
			if(CompanyQualificationsService.instance().countfindByTrainingProviderApplication(trainingProviderApplication, companylearners.getQualification() , true ) > 0) {
				showInfo = true;
				this.companylearners.setTrainingProviderApplication(trainingProviderApplication);
				this.companylearners.setCompany(trainingProviderApplication.getCompany());
			}else {
				...
				this.companylearners.setSkillsSet(null);
				this.companylearners.setUnitStandard(null);
				throw new Exception("Selected training provider is not accredited for the selected qualification");
			}
		}else {
		...
		try {
			if(getSessionUI().getTask() != null && getSessionUI().getTask().getWorkflowProcess() != null) {
				if (getSessionUI().getTask().getWorkflowProcess() == ConfigDocProcessEnum.Learner) {
					...
					l = rejectReasonsService.findByProcess(ConfigDocProcessEnum.LearnerRegistration);
				}else if (getSessionUI().getTask().getWorkflowProcess() == ConfigDocProcessEnum.UnemployedBursaryLearnerRegistration) {
					l = rejectReasonsService.findByProcess(ConfigDocProcessEnum.UnemployedBursaryLearnerRegistration);
				}else if (getSessionUI().getTask().getWorkflowProcess() == ConfigDocProcessEnum.LearnerRegistrationDocuments) {
					l = rejectReasonsService.findByProcess(ConfigDocProcessEnum.LearnerRegistrationDocuments);
				}
			}
		} catch (Exception e) {
			e.printStackTrace();
	...
	public List<Qualification> completeQualificationByLearningProgrammeQual(String desc) {
		...
		List<Qualification>        l                          = null;
		try {
			if(selectedQualification.getCodeString() != null) {
