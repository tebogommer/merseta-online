 ...
 */
@ManagedBean(name = "sdfcompanyUI")
@ViewScoped
public class SDFCompanyUI extends AbstractUI {
	...
	public void saveSDFAndCreatetask() {
		try {
			...
			usersService.validateEmailAddressByUser(newSDF);
			validiationErrors = "";
			StringBuilder errors = usersService.validiateUserInformation(newSDF);
