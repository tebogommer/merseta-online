 ...
 */
@ManagedBean(name = "pivitolplanUI")
@ViewScoped
public class PivitolPlanUI extends AbstractUI {
	...
	public void pivitolInfo() {
		try {
			mandatoryGrants = mandatoryGrantService.findByWSPPivotalPlan(getSessionUI().getWspSession(), wspReport, HAJConstants.YES_ID);
