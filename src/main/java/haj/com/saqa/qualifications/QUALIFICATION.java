...
public class QUALIFICATION implements IDataEntity{
    ...
    protected List<USQUALIFICATIONLINK> usqualificationlink;

    /** The lpqualificationlink. */
    @Transient
    @XmlElement(name = "LP_QUALIFICATION_LINK")
    protected List<SAQAQUALIFICATIONS.LPQUALIFICATIONLINK> lpqualificationlink;
     ...
     */
    public List<USQUALIFICATIONLINK> getUSQUALIFICATIONLINK() {
        if (usqualificationlink == null) {
            usqualificationlink = new ArrayList<USQUALIFICATIONLINK>();
        }
     ...
     */
    public List<SAQAQUALIFICATIONS.LPQUALIFICATIONLINK> getLPQUALIFICATIONLINK() {
        if (lpqualificationlink == null) {
            lpqualificationlink = new ArrayList<SAQAQUALIFICATIONS.LPQUALIFICATIONLINK>();
        }
