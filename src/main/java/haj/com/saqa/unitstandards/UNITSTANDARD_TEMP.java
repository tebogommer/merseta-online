...
public class UNITSTANDARD_TEMP implements IDataEntity{
 ...
 // **************************************************************** //
    ...
    @Column(name = "usregistrationstartdate")
    protected Date usregistrationstartDate;
    ...
    @XmlTransient
	@Temporal(TemporalType.TIMESTAMP)
    @Column(name = "usregistrationenddate")
    protected Date usregistrationendDate;
	...
	public String toString() {
		return "UNITSTANDARD_TEMP [downloaddate=" + downloaddate + ", lastupdatedate=" + lastupdatedate + ", unitstandardid="
