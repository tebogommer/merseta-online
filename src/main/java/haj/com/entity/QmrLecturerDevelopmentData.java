...
/**
 * QmrLecturerDevelopmentData.
 *
 * @author Techfinium
 */
@Entity
@Table(name = "qmr_lecturer_development_data")
@AuditTable(value = "qmr_lecturer_development_data_hist")
@Audited
public class QmrLecturerDevelopmentData implements IDataEntity {

	/** The Constant serialVersionUID. */
	private static final long serialVersionUID = 1L;

	/** Unique Id of QmrLecturerDevelopmentData. */
	@Id
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		QmrLecturerDevelopmentData other = (QmrLecturerDevelopmentData) obj;
		if (id == null) {
			if (other.id != null)
				return false;
	...
	/*
	 * Index:
	 * CREATE INDEX IDX_DR_qmr_lecturer_development_data ON merseta.qmr_lecturer_development_data (qmr_fin_years_id, qmr_entered_completed);
	 */
