...
public class FormSectionQuestionsAnswers implements IDataEntity, Cloneable {
	...
	private FormSectionQuestionsAnswers formSectionQuestions;
	...
	public boolean equals(Object obj) {
		...
		FormSectionQuestionsAnswers other = (FormSectionQuestionsAnswers) obj;
		if (id == null) {
	 ...
	 */
	public FormSectionQuestionsAnswers clone() {
		FormSectionQuestionsAnswers clone = null;
		try {
			clone = (FormSectionQuestionsAnswers) super.clone();
			clone.setId(null);
	...
	public FormSectionQuestionsAnswers clone(FormTypeSections formTypeSections) {
		FormSectionQuestionsAnswers clone = null;
		try {
			clone = (FormSectionQuestionsAnswers) super.clone();
	...
	public FormSectionQuestionsAnswers clone(FormSectionQuestionsAnswers formTypeSections) {
		FormSectionQuestionsAnswers clone = null;
		try {
			clone = (FormSectionQuestionsAnswers) super.clone();
	 ...
	 */
	public FormSectionQuestionsAnswers() {
		super();
	 ...
	 */
	public FormSectionQuestionsAnswers getFormSectionQuestions() {
	 ...
	 */
	public void setFormSectionQuestions(FormSectionQuestionsAnswers formSectionQuestions) {
