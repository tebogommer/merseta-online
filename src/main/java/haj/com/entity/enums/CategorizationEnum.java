...
public enum CategorizationEnum {
	 ...
	 *            the display name X
	 */
	private CategorizationEnum(String displayNameX) {
	 ...
	 */
	public static final CategorizationEnum getIdPassportEnumByValue(String value) {
		Integer val = 0;
		try {
		...
		for (CategorizationEnum status : CategorizationEnum.values()) {
