...
/**
 * QmrSkillsProgrammeData.
 *
 * @author Techfinium
 */
@Entity
@Table(name = "qmr_skills_programme_data")
@AuditTable(value = "qmr_skills_programme_data_hist")
@Audited
public class QmrSkillsProgrammeData implements IDataEntity {

	/** The Constant serialVersionUID. */
	private static final long serialVersionUID = 1L;

	/** Unique Id of QmrSkillsProgrammeData. */
	@Id
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		QmrSkillsProgrammeData other = (QmrSkillsProgrammeData) obj;
		if (id == null) {
			if (other.id != null)
				return false;
	 ...
	 * 
	 * Data Read:
	 * CREATE INDEX IDX_DR_qmr_skills_programme_data ON merseta.qmr_skills_programme_data (qmr_fin_years_id, qmr_entered_completed, employed_un_employed);
	 */
