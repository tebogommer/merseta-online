 ...
 */
@Entity
@Table(name = "company_learners")
@AuditTable(value = "company_learners_hist")
@Audited
@ExportValidation(message = "Invalid Company Learners Profile")
public class CompanyLearners implements IDataEntity {
	...
	@SETMISFieldValidation(process = true, fieldName = "site", fieldValue = "NOT_NULL")
	private Sites site;
	...
	@SETMISFieldValidation(process = true, fieldName = "employer", fieldValue = "NOT_NULL")
	...
	@Column(name = "non_credid_bearing_description", length = 200)
	...
	@SETMISFieldValidation(process = true, fieldName = "hostCompany", fieldValue = "NOT_NULL")
	...
	@Audited(targetAuditMode = RelationTargetAuditMode.NOT_AUDITED)
	@ManyToOne(fetch = FetchType.LAZY)
	@JoinColumn(name = "sme_qualification_id", nullable = true)
	private SmeQualifications smeQualification;

	@Column(name = "merseta_registration", nullable = true)
	public Boolean mersetaRegistration;

	@Column(name = "legacy_id", nullable = true)
	private Long legacyId;

	@Column(name = "legacy_target_class")
	private String legacyTargetClass;

	@Temporal(TemporalType.TIMESTAMP)
	@Column(name = "date_qualification_obtained", length = 19)
	private Date dateQualificationObtained;

	// timestamp of when learner passed their last trade test date
	@Temporal(TemporalType.TIMESTAMP)
	@Column(name = "last_passed_test_date", length = 19)
	private Date lastPassedTestDate;
	...
	// completion date when it ends
	@Temporal(TemporalType.TIMESTAMP)
	@Column(name = "legacy_registration_date", length = 19)
	private Date legacyRegistrationDate;
	
	@ManyToOne(fetch = FetchType.LAZY)
	@JoinColumn(name = "test_centre_training_provider_application_id", nullable = true)
	private TrainingProviderApplication testCentreTrainingProviderApplication;
	
	@ManyToOne(fetch = FetchType.LAZY)
	@JoinColumn(name = "leaning_programme_id", nullable = true)
	private Qualification leaningProgramme;
	
	@Temporal(TemporalType.TIMESTAMP)
	@Column(name = "date_learner_registered", length = 19)
	private Date dateLearnerRegistered;
	
	@Temporal(TemporalType.TIMESTAMP)
	@Column(name = "date_learner_completed", length = 19)
	private Date dateLearnerCompleted;
	
	@Temporal(TemporalType.TIMESTAMP)
	@Column(name = "date_learner_terminated", length = 19)
	private Date dateLearnerTerminated;
	...
	@Fetch(FetchMode.JOIN)
	@ManyToOne(fetch = FetchType.LAZY)
	@JoinColumn(name = "tvet_fet_qualification_id", nullable = true)
	private TvetFetQualification tvetFetQualification;
	
	@ManyToOne(fetch = FetchType.LAZY)
	@JoinColumn(name = "company_learners_bursary_link_id", nullable = true)
	private CompanyLearners company_learners_bursary_link;
	
	@Column(name = "new_bursary", nullable = true, columnDefinition = "BIT default false")
	public Boolean newBursary;
	
	@Enumerated
	@Column(name = "document_change_status")
	private ApprovalEnum documentChangeStatus;
	...
	@Enumerated
	@Column(name = "tvet_lecturer")
	private YesNoEnum tvetLecturer;
	
	@Column(name = "e_learner", nullable = true, columnDefinition = "BIT default false")
	public Boolean elearner;
	
	@ManyToOne(fetch = FetchType.LAZY)
	@JoinColumn(name = "training_site_id", nullable = true)
	private TrainingSite trainingSite;
	
	@Column(name = "continuation_flag")
	private Integer continuation_flag;
	...
	@Transient
	private boolean continuation_flag_check;
	
	@Transient
	private boolean continuation_flag_check_status;
	...
	@Transient
	private List<CompletionLetter> completionLetters;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		CompanyLearners other = (CompanyLearners) obj;
		if (id == null) {
			if (other.id != null)
				return false;
	 ...
	 */
	public CompanyLearners() {
		super();
		this.learnerStatus = LearnerStatusEnum.Application;
	}

	public CompanyLearners(CompanyLearners companyLearnersParent) {
		super();
	...
	public Qualification getNonNullQualification() {
		return qualification != null ? qualification
				: skillsSet != null ? skillsSet.getQualification() : skillsProgram.getQualification();
	}
	...
	/**
	 * @param systemTermination
	 *            the systemTermination to set
	 */
	...
	public SmeQualifications getSmeQualification() {
		return smeQualification;
	}

	public void setSmeQualification(SmeQualifications smeQualification) {
		this.smeQualification = smeQualification;
	}

	public Boolean getMersetaRegistration() {
		return mersetaRegistration;
	}

	public void setMersetaRegistration(Boolean mersetaRegistration) {
		this.mersetaRegistration = mersetaRegistration;
	}
	...
	public Date getDateQualificationObtained() {
		return dateQualificationObtained;
	}

	public void setDateQualificationObtained(Date dateQualificationObtained) {
		this.dateQualificationObtained = dateQualificationObtained;
	}

	public Date getLastPassedTestDate() {
		return lastPassedTestDate;
	}

	public void setLastPassedTestDate(Date lastPassedTestDate) {
		this.lastPassedTestDate = lastPassedTestDate;
	}

	public String getLegacyTargetClass() {
		return legacyTargetClass;
	}

	public void setLegacyTargetClass(String legacyTargetClass) {
		this.legacyTargetClass = legacyTargetClass;
	}
	...
	public Date getLegacyRegistrationDate() {
		return legacyRegistrationDate;
	}

	public void setLegacyRegistrationDate(Date legacyRegistrationDate) {
		this.legacyRegistrationDate = legacyRegistrationDate;
	}

	public TrainingProviderApplication getTestCentreTrainingProviderApplication() {
		return testCentreTrainingProviderApplication;
	}

	public void setTestCentreTrainingProviderApplication(
			TrainingProviderApplication testCentreTrainingProviderApplication) {
		this.testCentreTrainingProviderApplication = testCentreTrainingProviderApplication;
	}

	public Qualification getLeaningProgramme() {
		return leaningProgramme;
	}

	public void setLeaningProgramme(Qualification leaningProgramme) {
		this.leaningProgramme = leaningProgramme;
	}

	public Date getDateLearnerRegistered() {
		return dateLearnerRegistered;
	}

	public void setDateLearnerRegistered(Date dateLearnerRegistered) {
		this.dateLearnerRegistered = dateLearnerRegistered;
	}

	public Date getDateLearnerCompleted() {
		return dateLearnerCompleted;
	}

	public void setDateLearnerCompleted(Date dateLearnerCompleted) {
		this.dateLearnerCompleted = dateLearnerCompleted;
	}

	public Date getDateLearnerTerminated() {
		return dateLearnerTerminated;
	}

	public void setDateLearnerTerminated(Date dateLearnerTerminated) {
		this.dateLearnerTerminated = dateLearnerTerminated;
	}
	...
	public CompanyLearners getCompany_learners_bursary_link() {
		return company_learners_bursary_link;
	}

	public void setCompany_learners_bursary_link(CompanyLearners company_learners_bursary_link) {
		this.company_learners_bursary_link = company_learners_bursary_link;
	}

	public Boolean getNewBursary() {
		return newBursary;
	}

	public void setNewBursary(Boolean newBursary) {
		this.newBursary = newBursary;
	}

	public ApprovalEnum getDocumentChangeStatus() {
		return documentChangeStatus;
	}

	public void setDocumentChangeStatus(ApprovalEnum documentChangeStatus) {
		this.documentChangeStatus = documentChangeStatus;
	}
	...
	public List<CompletionLetter> getCompletionLetters() {
		return completionLetters;
	}

	public void setCompletionLetters(List<CompletionLetter> completionLetters) {
		this.completionLetters = completionLetters;
	}

	public YesNoEnum getTvetLecturer() {
		return tvetLecturer;
	}

	public void setTvetLecturer(YesNoEnum tvetLecturer) {
		this.tvetLecturer = tvetLecturer;
	}

	public Boolean getElearner() {
		return elearner;
	}

	public void setElearner(Boolean elearner) {
	...
	public Integer getContinuation_flag() {
		return continuation_flag;
	}

	public void setContinuation_flag(Integer continuation_flag) {
		this.continuation_flag = continuation_flag;
	}

	public boolean isContinuation_flag_check() {
		return continuation_flag_check;
	}

	public void setContinuation_flag_check(boolean continuation_flag_check) {
		this.continuation_flag_check = continuation_flag_check;
	}

	public boolean isContinuation_flag_check_status() {
		return continuation_flag_check_status;
	}

	public void setContinuation_flag_check_status(boolean continuation_flag_check_status) {
		this.continuation_flag_check_status = continuation_flag_check_status;
	}
