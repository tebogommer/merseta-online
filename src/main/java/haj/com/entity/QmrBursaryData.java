 ...
 */
@Entity
@Table(name = "qmr_bursary_data")
@AuditTable(value = "qmr_bursary_data_hist")
@Audited
public class QmrBursaryData implements IDataEntity {

	/** The Constant serialVersionUID. */
	private static final long serialVersionUID = 1L;

	/** Unique Id of QmrBursaryData. */
	@Id
	...
	// True for new bursary, false for continuing
	@Column(name = "new_bursary_identified")
	private Boolean newBursaryIdentified;
	...
	@Column(name = "description_of_the_qualification")
	private String descriptionOfTheQualification;
	...
	@Column(name = "new_continuing_bursary")
	private String newContinuingBursary;
	/* QMR Data End */
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		QmrBursaryData other = (QmrBursaryData) obj;
		if (id == null) {
			if (other.id != null)
				return false;
	 ...
	 * Indexes:
	 * Data Read:
	 * CREATE INDEX IDX_DR_qmr_bursary_data ON merseta.qmr_bursary_data (qmr_fin_years_id, qmr_entered_completed, employed_un_employed);
	 * 
	 */
	...
	public String getDescriptionOfTheQualification() {
		return descriptionOfTheQualification;
	}

	public void setDescriptionOfTheQualification(String descriptionOfTheQualification) {
		this.descriptionOfTheQualification = descriptionOfTheQualification;
	}

	public Boolean getNewBursaryIdentified() {
		return newBursaryIdentified;
	}

	public void setNewBursaryIdentified(Boolean newBursaryIdentified) {
		this.newBursaryIdentified = newBursaryIdentified;
	}

	public String getNewContinuingBursary() {
		return newContinuingBursary;
	}

	public void setNewContinuingBursary(String newContinuingBursary) {
		this.newContinuingBursary = newContinuingBursary;
	}
