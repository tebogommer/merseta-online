 ...
 */
@Entity
@Table(name = "qmr_aet_programme_data")
@AuditTable(value = "qmr_aet_programme_data_hist")
@Audited
public class QmrAETProgrammeData implements IDataEntity {

	/** The Constant serialVersionUID. */
	private static final long serialVersionUID = 1L;

	/** Unique Id of QmrAETProgrammeData. */
	@Id
	...
	@Column(name = "aet_programme_level")
	...
	@Column(name = "date_entered_the_programme")
	...
	@Column(name = "date_the_learner_issued_with_certificate") /* this field is only recorded for completed, i.e. not for entered */
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		QmrAETProgrammeData other = (QmrAETProgrammeData) obj;
		if (id == null) {
			if (other.id != null)
				return false;
	...
	/*
	 * Index:
	 * CREATE INDEX IDX_DR_qmr_aet_programme_data ON merseta.qmr_aet_programme_data (qmr_fin_years_id, qmr_entered_completed);
	 */
