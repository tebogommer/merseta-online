 ...
 */
@Entity
@Table(name = "learner_mentor_ratio")
public class LearnerMentorRatio extends AbstractLookup {
	...
	@Column(name = "no_of_mentors")
	private Integer noOfMentors;
	...
	public boolean equals(Object obj) {
		...
		LearnerMentorRatio other = (LearnerMentorRatio) obj;
		if (id == null) {
	...
	public Integer getNoOfMentors() {
		return noOfMentors;
	}

	public void setNoOfMentors(Integer noOfMentors) {
