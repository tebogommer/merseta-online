 ...
 */
@Entity
@Table(name = "purpose_of_site_visit_child")
public class PurposeOfSiteVisitChild extends AbstractLookup {
	...
	@JoinColumn(name = "purpose_of_site_visit_parent", nullable = true)
	private PurposeOfSiteVisit purposeOfSiteVisit;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		PurposeOfSiteVisitChild other = (PurposeOfSiteVisitChild) obj;
		if (id == null) {
			if (other.id != null)
				return false;
