 ...
 */
@Entity
@Table(name = "modules_category")
public class ModulesCategory extends AbstractLookup {
	...
	@Column(name = "second_description", length = 500)
	private String secondDescription;

	@Column(name = "third_description", length = 500)
	private String thirdDescription;

	@Column(name = "fourth_description", length = 500)
	...
	public boolean equals(Object obj) {
		...
		ModulesCategory other = (ModulesCategory) obj;
		if (id == null) {
