...
/**
 * The Class LearnershipUnitStandards.
 */
@Entity
@Table(name = "learnership_unit_standards")
public class LearnershipUnitStandards extends AbstractLookup {
	...
	public LearnershipUnitStandards() {
		super();
	}

	public LearnershipUnitStandards(Learnership learnership, UnitStandards unitStandards) {
		super();
		this.learnership = learnership;
		this.unitStandards = unitStandards;
	}
	
	public LearnershipUnitStandards(Learnership learnership, UnitStandards unitStandards, Qualification qualification) {
		super();
		this.learnership = learnership;
		this.unitStandards = unitStandards;
	...
	public boolean equals(Object obj) {
		...
		LearnershipUnitStandards other = (LearnershipUnitStandards) obj;
		if (id == null) {
