 ...
 */
@Entity
@Table(name = "legacy_organisation_levy_paying")
public class LegacyOrganisationLevyPaying extends AbstractLookup {
	 ...
	 */
	public LegacyOrganisationLevyPaying() {
		super();
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		LegacyOrganisationLevyPaying other = (LegacyOrganisationLevyPaying) obj;
		if (id == null) {
			if (other.id != null)
				return false;
