 ...
 */
@Entity
@Table(name = "work_place_approval_tool_list")
public class WorkPlaceApprovalToolList implements IDataEntity {
	...
	@ManyToOne(fetch = FetchType.LAZY)
	@JoinColumn(name = "qualification_tool_list_id", nullable = true)
	private QualificationToolList qualificationToolList;
	
	@ManyToOne(fetch = FetchType.LAZY)
	@Fetch(FetchMode.JOIN)
	@JoinColumn(name = "tool_list_id", nullable = true)
	private ToolList toolList;
	
	@ManyToOne(fetch = FetchType.LAZY)
	@Fetch(FetchMode.JOIN)
	@JoinColumn(name = "tool_list_tools_id", nullable = true)
	private ToolListTools toolListTools;
	 ...
	 */
	public WorkPlaceApprovalToolList() {
		super();
		// TODO Auto-generated constructor stub
	}

	public WorkPlaceApprovalToolList(QualificationToolList qualificationToolList, WorkPlaceApproval workPlaceApproval, ToolList toolList, ToolListTools toolListTools) {
		this.workPlaceApproval=workPlaceApproval;
		this.qualificationToolList=qualificationToolList;
		this.toolList =toolList;
		this.toolListTools = toolListTools;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		WorkPlaceApprovalToolList other = (WorkPlaceApprovalToolList) obj;
		if (id == null) {
			if (other.id != null)
				return false;
	...
	public ToolListTools getToolListTools() {
		return toolListTools;
	}

	public void setToolListTools(ToolListTools toolListTools) {
		this.toolListTools = toolListTools;
	}
}
