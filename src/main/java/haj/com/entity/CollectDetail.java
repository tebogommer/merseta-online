...
public class CollectDetail implements IDataEntity
{
	...
	/**Registered Mail*/
	@Column(name = "registered_mail_number  ")
	private String registeredMailNumber  ;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		CollectDetail other = (CollectDetail) obj;
		if (id == null) {
			if (other.id != null)
				return false;
	...
	public void setRegisteredMailNumber(String registeredMailNumber) {
		this.registeredMailNumber = registeredMailNumber;
	}
