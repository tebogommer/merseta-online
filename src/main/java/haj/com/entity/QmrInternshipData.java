 ...
 */
@Entity
@Table(name = "qmr_internship_data")
@AuditTable(value = "qmr_internship_data_hist")
@Audited
public class QmrInternshipData implements IDataEntity {

	/** The Constant serialVersionUID. */
	private static final long serialVersionUID = 1L;

	/** Unique Id of QmrInternshipData. */
	@Id
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		QmrInternshipData other = (QmrInternshipData) obj;
		if (id == null) {
			if (other.id != null)
				return false;
	...
	/*
	 * Index:
	 * CREATE INDEX IDX_DR_qmr_internship_data ON merseta.qmr_internship_data (qmr_fin_years_id, qmr_entered_completed, employed_un_employed);
	 */
