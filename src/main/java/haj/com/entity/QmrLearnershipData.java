 ...
 */
@Entity
@Table(name = "qmr_learnership_data")
@AuditTable(value = "qmr_learnership_data_hist")
@Audited
public class QmrLearnershipData implements IDataEntity {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		QmrLearnershipData other = (QmrLearnershipData) obj;
		if (id == null) {
			if (other.id != null)
				return false;
	 ...
	 * 
	 * Data Read:
	 * MySQL: CREATE INDEX IDX_DATA_qmr_learnership_data ON merseta.qmr_learnership_data (qmr_fin_years_id, qmr_entered_completed, employed_un_employed);
	 */
