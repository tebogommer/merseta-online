...
@Entity
@Table(name = "wsp_company_training_comittee_history")
public class WspCompanyTrainingComitteeHistory implements IDataEntity,Cloneable {
	...
	/** The Id of TrainingComittee Entity where referenced */
	@Column(name = "orginal_training_comittee_id")
	private Long orginalTrainingComitteeId;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		WspCompanyTrainingComitteeHistory other = (WspCompanyTrainingComitteeHistory) obj;
		if (id == null) {
			if (other.id != null)
				return false;
	...
	public Long getOrginalTrainingComitteeId() {
		return orginalTrainingComitteeId;
	}

	public void setOrginalTrainingComitteeId(Long orginalTrainingComitteeId) {
		this.orginalTrainingComitteeId = orginalTrainingComitteeId;
	}
	...
	public Long getCompanyOriginal() {
		return companyOriginal;
	}

	public void setCompanyOriginal(Long companyOriginal) {
		this.companyOriginal = companyOriginal;
	}
