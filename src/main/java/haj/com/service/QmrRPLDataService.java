...
import haj.com.dao.QmrRPLDataDAO;
...
/**
 * The Class QmrRPLDataService.
 */
public class QmrRPLDataService extends AbstractService {
	/** The dao. */
	private QmrRPLDataDAO dao = new QmrRPLDataDAO();
	 ...
	 *
	 * @author TechFinium
	 * @return a list of {@link haj.com.entity.QmrRPLData}
	 * @throws Exception the exception
	 * @see QmrRPLData
	 */
	public List<QmrRPLData> allQmrRPLData() throws Exception {
		return dao.allQmrRPLData();
	}

	/**
	 * Create or update QmrRPLData.
	 *
	 * @author TechFinium
	 ...
	 * @see QmrRPLData
	 */
	public void create(QmrRPLData entity) throws Exception {
	 ...
	 * @see QmrRPLData
	 */
	public void update(QmrRPLData entity) throws Exception {
		this.dao.update(entity);
	}
	 ...
	 * @see QmrRPLData
	 */
	public void delete(QmrRPLData entity) throws Exception {
	 ...
	 * @author TechFinium
	 * @param id the id
	 * @return a {@link haj.com.entity.QmrRPLData}
	 * @throws Exception the exception
	 * @see QmrRPLData
	 */
	public QmrRPLData findByKey(long id) throws Exception {
		return dao.findByKey(id);
	}

	/**
	 * Find QmrRPLData by description.
	 *
	 * @author TechFinium
	 * @param desc the desc
	 * @return a list of {@link haj.com.entity.QmrRPLData}
	 ...
	 * @see QmrRPLData
	 */
	public List<QmrRPLData> findByName(String desc) throws Exception {
		return dao.findByName(desc);
	}

	/**
	 * Lazy load QmrRPLData.
	 *
	 ...
	 * @throws Exception the exception
	 */
	public List<QmrRPLData> allQmrRPLData(int first, int pageSize) throws Exception {
		return dao.allQmrRPLData(Long.valueOf(first), pageSize);
	}

	/**
	 * Get count of QmrRPLData for lazy load.
	 *
	 * @author TechFinium
	 * @return Number of rows in the QmrRPLData
	 * @throws Exception the exception
	 */
	public Long count() throws Exception {
		return dao.count(QmrRPLData.class);
	}

	/**
	 * Lazy load QmrRPLData with pagination, filter, sorting.
	 *
	 * @author TechFinium
	 * @param class1    QmrRPLData class
	 * @param first     the first
	 * @param pageSize  the page size
	 * @param sortField the sort field
	 * @param sortOrder the sort order
	 * @param filters   the filters
	 * @return a list of {@link haj.com.entity.QmrRPLData} containing data
	 * @throws Exception the exception
	 */
	@SuppressWarnings("unchecked")
	public List<QmrRPLData> allQmrRPLData(Class<QmrRPLData> class1, int first, int pageSize, String sortField, SortOrder sortOrder, Map<String, Object> filters) throws Exception {
		return (List<QmrRPLData>) dao.sortAndFilter(class1, first, pageSize, sortField, sortOrder, filters);

	}

	/**
	 * Get count of QmrRPLData for lazy load with filters.
	 *
	 * @author TechFinium
	 * @param entity  QmrRPLData class
	 * @param filters the filters
	 * @return Number of rows in the QmrRPLData entity
	 * @throws Exception the exception
	 */
	public int count(Class<QmrRPLData> entity, Map<String, Object> filters) throws Exception {
...
//					femaleCount = dao.countByYouthIdentfiedWithGenderAndEquity(selectedQuarter.getId(), employmentStatusEnum.get(0), qmrEnteredCompletedEnum, HAJConstants.QMR_AGE_YOUTH, QmrGenderEnum.FEMALE, report.getQmrEquityEnum());
	 ...
	 * RPL Entered
	 */
	public List<QmrSummaryBean> generateSummaryReportRPLEntered(Integer finYearPassed) throws Exception {
		List<QmrTypeSelectionEnum> qmrTypeSelectionEnumList = QmrGenericService.instance().addQmrTypeSelectionEnumToArrayList(QmrTypeSelectionEnum.RPL);
	...
	/*
	 * Generate Count Report: RPL Entered
	 */
	public List<QmrQuarterCountBean> generateCountReportRPLEntered(QmrFinYears selectedQuarter) throws Exception {
		List<QmrTypeSelectionEnum> qmrTypeSelectionEnumList = QmrGenericService.instance().addQmrTypeSelectionEnumToArrayList(QmrTypeSelectionEnum.RPL);
		List<EmploymentStatusEnum> employmentStatusEnum = null;
		List<LearnerStatusEnum> learnerStatusEnumList = QmrGenericService.instance().prepLearnerStatusEnumBasedOnIndicator(2);
		QmrEnteredCompletedEnum qmrEnteredCompletedEnum = QmrEnteredCompletedEnum.Completed;
	...
	/*
	 * Pull RPL Entered: Data Report Saved Data
	 */
	public List<QmrRPLData> fetchSavedDataRPLEnteredForQuarter(QmrFinYears qmrFinYears) throws Exception {
		List<EmploymentStatusEnum> employmentStatusEnum = null;
		QmrEnteredCompletedEnum qmrEnteredCompletedEnum = QmrEnteredCompletedEnum.Completed;
		return dao.findDataForReport(qmrFinYears.getId(), employmentStatusEnum, qmrEnteredCompletedEnum);
	}
	
	public Integer fetchSavedDataRPLEnteredForQuarterCount(QmrFinYears qmrFinYears) throws Exception {
		List<EmploymentStatusEnum> employmentStatusEnum = null;
		QmrEnteredCompletedEnum qmrEnteredCompletedEnum = QmrEnteredCompletedEnum.Completed;
	...
	/*
	 * Pull RPL Entered: Data Report Not Saved Data
	 */
	public List<QmrScriptOneBean> runRPLEnteredForQuarterNotSaved(QmrFinYears qmrFinYears) throws Exception {
	...
	public List<CounterBean> runRPLEnteredForQuarterNotSavedCount(QmrFinYears qmrFinYears) throws Exception {
		/* Prep data for report */
		List<QmrTypeSelectionEnum> qmrTypeSelectionEnumList = QmrGenericService.instance().addQmrTypeSelectionEnumToArrayList(QmrTypeSelectionEnum.RPL);
		List<EmploymentStatusEnum> employmentStatusEnum = null;
		List<LearnerStatusEnum> learnerStatusEnumList = QmrGenericService.instance().prepLearnerStatusEnumBasedOnIndicator(2);
	...
	/**
	 * Generates List<haj.com.entity.QmrRPLData> for a quarter provided. 
	 * 
	 * @param qmrFinYears
	 * @return List<QmrRPLData>
	 * @throws Exception
	 */
	public List<QmrRPLData> generateQuaterData(QmrFinYears qmrFinYears) throws Exception {
		
		List<QmrScriptOneBean> results = null;
		List<QmrRPLData> transformedResults = null;
		List<QmrRPLData> returnResults = new ArrayList<>();
		
		results = runRPLEnteredForQuarterNotSaved(qmrFinYears);
		if (!results.isEmpty()) {
	 ...
	 * @throws Exception
	 */
	private List<QmrRPLData> populateDataIntoReportingForm(List<QmrScriptOneBean> extractedResults, QmrFinYears qmrFinYears, QmrEnteredCompletedEnum qmrEnteredCompletedEnum, EmploymentStatusEnum employmentStatusEnum) throws Exception {
		List<QmrRPLData> results = new ArrayList<>();
		for (QmrScriptOneBean bean : extractedResults) {
			QmrRPLData newEntry = new QmrRPLData();
