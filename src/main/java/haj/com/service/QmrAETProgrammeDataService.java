...
import haj.com.dao.QmrAETProgrammeDataDAO;
...
/**
 * The Class QmrAETProgrammeDataService.
 */
public class QmrAETProgrammeDataService extends AbstractService {
	/** The dao. */
	private QmrAETProgrammeDataDAO dao = new QmrAETProgrammeDataDAO();
	...
	public List<QmrAETProgrammeData> allQmrAETProgrammeData() throws Exception {
		return dao.allQmrAETProgrammeData();
	}

	/**
	 * Create or update QmrAETProgrammeData.
	 *
	 * @author TechFinium
	 ...
	 * @see QmrAETProgrammeData
	 */
	public void create(QmrAETProgrammeData entity) throws Exception {
	 ...
	 * @see QmrAETProgrammeData
	 */
	public void update(QmrAETProgrammeData entity) throws Exception {
		this.dao.update(entity);
	}

	/**
	 * Delete QmrAETProgrammeData.
	 *
	 * @author TechFinium
	 * @param entity the entity
	 * @throws Exception the exception
	 * @see QmrAETProgrammeData
	 */
	public void delete(QmrAETProgrammeData entity) throws Exception {
	 ...
	 * @see QmrAETProgrammeData
	 */
	public List<QmrAETProgrammeData> findByName(String desc) throws Exception {
		return dao.findByName(desc);
	}

	/**
	 * Lazy load QmrAETProgrammeData.
	 *
	 ...
	 * @throws Exception the exception
	 */
	public List<QmrAETProgrammeData> allQmrAETProgrammeData(int first, int pageSize) throws Exception {
		return dao.allQmrAETProgrammeData(Long.valueOf(first), pageSize);
	}

	/**
	 * Get count of QmrAETProgrammeData for lazy load.
	 *
	 * @author TechFinium
	 * @return Number of rows in the QmrAETProgrammeData
	 * @throws Exception the exception
	 */
	public Long count() throws Exception {
		return dao.count(QmrAETProgrammeData.class);
	}

	/**
	 * Lazy load QmrAETProgrammeData with pagination, filter, sorting.
	 *
	 * @author TechFinium
	 * @param class1    QmrAETProgrammeData class
	 * @param first     the first
	 * @param pageSize  the page size
	 * @param sortField the sort field
	 * @param sortOrder the sort order
	 * @param filters   the filters
	 * @return a list of {@link haj.com.entity.QmrAETProgrammeData} containing data
	 * @throws Exception the exception
	 */
	@SuppressWarnings("unchecked")
	public List<QmrAETProgrammeData> allQmrAETProgrammeData(Class<QmrAETProgrammeData> class1, int first, int pageSize, String sortField, SortOrder sortOrder, Map<String, Object> filters) throws Exception {
		return (List<QmrAETProgrammeData>) dao.sortAndFilter(class1, first, pageSize, sortField, sortOrder, filters);

	}

	/**
	 * Get count of QmrAETProgrammeData for lazy load with filters.
	 *
	 * @author TechFinium
	 * @param entity  QmrAETProgrammeData class
	 * @param filters the filters
	 * @return Number of rows in the QmrAETProgrammeData entity
	 * @throws Exception the exception
	 */
	public int count(Class<QmrAETProgrammeData> entity, Map<String, Object> filters) throws Exception {
...
//					femaleCount = dao.countByYouthIdentfiedWithGenderAndEquity(selectedQuarter.getId(), employmentStatusEnum.get(0), qmrEnteredCompletedEnum, HAJConstants.QMR_AGE_YOUTH, QmrGenderEnum.FEMALE, report.getQmrEquityEnum());
	 ...
	 * AET Programme Entered
	 */
	public List<QmrSummaryBean> generateSummaryReportAETProgrammeEntered(Integer finYearPassed) throws Exception {
		List<QmrTypeSelectionEnum> qmrTypeSelectionEnumList = QmrGenericService.instance().addQmrTypeSelectionEnumToArrayList(QmrTypeSelectionEnum.AET_PROGRAMMES);
	...
	/*
	 * Generate Summary Report:
	 * AET Programme Completed
	 */
	public List<QmrSummaryBean> generateSummaryReportAETProgrammeCompleted(Integer finYearPassed) throws Exception {
		List<QmrTypeSelectionEnum> qmrTypeSelectionEnumList = QmrGenericService.instance().addQmrTypeSelectionEnumToArrayList(QmrTypeSelectionEnum.AET_PROGRAMMES);
		List<EmploymentStatusEnum> employmentStatusEnum = null;
	...
	/*
	 * Generate Count Report: AET Programme Entered
	 */
	public List<QmrQuarterCountBean> generateCountReportAETProgrammeEntered(QmrFinYears selectedQuarter) throws Exception {
		List<QmrTypeSelectionEnum> qmrTypeSelectionEnumList = QmrGenericService.instance().addQmrTypeSelectionEnumToArrayList(QmrTypeSelectionEnum.AET_PROGRAMMES);
		List<EmploymentStatusEnum> employmentStatusEnum = null;
		List<LearnerStatusEnum> learnerStatusEnumList = QmrGenericService.instance().prepLearnerStatusEnumBasedOnIndicator(1);
		QmrEnteredCompletedEnum qmrEnteredCompletedEnum = QmrEnteredCompletedEnum.Entered;
	...
	/*
	 * Generate Count Report: AET Programme Completed
	 */
	public List<QmrQuarterCountBean> generateCountReportAETProgrammeCompleted(QmrFinYears selectedQuarter) throws Exception {
		List<QmrTypeSelectionEnum> qmrTypeSelectionEnumList = QmrGenericService.instance().addQmrTypeSelectionEnumToArrayList(QmrTypeSelectionEnum.AET_PROGRAMMES);
		List<EmploymentStatusEnum> employmentStatusEnum = null;
		List<LearnerStatusEnum> learnerStatusEnumList = QmrGenericService.instance().prepLearnerStatusEnumBasedOnIndicator(2);
		QmrEnteredCompletedEnum qmrEnteredCompletedEnum = QmrEnteredCompletedEnum.Completed;
	...
	/*
	 * Pull AETProgramme Entered: Data Report Saved Data
	 */
	public List<QmrAETProgrammeData> fetchSavedDataAETProgrammeEnteredForQuarter(QmrFinYears qmrFinYears) throws Exception {
		List<EmploymentStatusEnum> employmentStatusEnum = null;
		QmrEnteredCompletedEnum qmrEnteredCompletedEnum = QmrEnteredCompletedEnum.Entered;
		return dao.findDataForReport(qmrFinYears.getId(), employmentStatusEnum, qmrEnteredCompletedEnum);
	}
	
	public Integer fetchSavedDataAETProgrammeEnteredForQuarterCount(QmrFinYears qmrFinYears) throws Exception {
		List<EmploymentStatusEnum> employmentStatusEnum = null;
		QmrEnteredCompletedEnum qmrEnteredCompletedEnum = QmrEnteredCompletedEnum.Entered;
	...
	/*
	 * Pull AETProgramme Completed: Data Report Saved Data
	 */
	public List<QmrAETProgrammeData> fetchSavedDataAETProgrammeCompletedForQuarter(QmrFinYears qmrFinYears) throws Exception {
		List<EmploymentStatusEnum> employmentStatusEnum = null;
		QmrEnteredCompletedEnum qmrEnteredCompletedEnum = QmrEnteredCompletedEnum.Completed;
		return dao.findDataForReport(qmrFinYears.getId(), employmentStatusEnum, qmrEnteredCompletedEnum);
	}
	
	public Integer fetchSavedDataAETProgrammeCompletedForQuarterCount(QmrFinYears qmrFinYears) throws Exception {
		List<EmploymentStatusEnum> employmentStatusEnum = null;
		QmrEnteredCompletedEnum qmrEnteredCompletedEnum = QmrEnteredCompletedEnum.Completed;
		return dao.findDataForReportCount(qmrFinYears.getId(), employmentStatusEnum, qmrEnteredCompletedEnum);
	}
	...
	/*
	 * Pull AET Programme Entered: Data Report Not Saved Data
	 */
	public List<QmrScriptFiveBean> runAETProgrammeEnteredForQuarterNotSaved(QmrFinYears qmrFinYears) throws Exception {
		/* Prep data for report */
		List<QmrTypeSelectionEnum> qmrTypeSelectionEnumList = QmrGenericService.instance().addQmrTypeSelectionEnumToArrayList(QmrTypeSelectionEnum.AET_PROGRAMMES);
		List<EmploymentStatusEnum> employmentStatusEnum = null;
		List<LearnerStatusEnum> learnerStatusEnumList = QmrGenericService.instance().prepLearnerStatusEnumBasedOnIndicator(1);
		QmrEnteredCompletedEnum qmrEnteredCompletedEnum = QmrEnteredCompletedEnum.Entered;
		return QmrGenericService.instance().populateScriptFiveBeanByQuarterNotSaved(qmrFinYears, qmrTypeSelectionEnumList, employmentStatusEnum, learnerStatusEnumList, qmrEnteredCompletedEnum);
	}
	
	public List<CounterBean> runAETProgrammeEnteredForQuarterNotSavedCount(QmrFinYears qmrFinYears) throws Exception {
		/* Prep data for report */
		List<QmrTypeSelectionEnum> qmrTypeSelectionEnumList = QmrGenericService.instance().addQmrTypeSelectionEnumToArrayList(QmrTypeSelectionEnum.AET_PROGRAMMES);
		List<EmploymentStatusEnum> employmentStatusEnum = null;
		List<LearnerStatusEnum> learnerStatusEnumList = QmrGenericService.instance().prepLearnerStatusEnumBasedOnIndicator(1);
	...
	/*
	 * Pull AET Programme Completed: Data Report Not Saved Data
	 */
	public List<QmrScriptFiveBean> runAETProgrammeCompletedForQuarterNotSaved(QmrFinYears qmrFinYears) throws Exception {
		/* Prep data for report */
		List<QmrTypeSelectionEnum> qmrTypeSelectionEnumList = QmrGenericService.instance().addQmrTypeSelectionEnumToArrayList(QmrTypeSelectionEnum.AET_PROGRAMMES);
		List<EmploymentStatusEnum> employmentStatusEnum = null;
		List<LearnerStatusEnum> learnerStatusEnumList = QmrGenericService.instance().prepLearnerStatusEnumBasedOnIndicator(2);
	...
	public List<CounterBean> runAETProgrammeCompletedForQuarterNotSavedCount(QmrFinYears qmrFinYears) throws Exception {
		/* Prep data for report */
		List<QmrTypeSelectionEnum> qmrTypeSelectionEnumList = QmrGenericService.instance().addQmrTypeSelectionEnumToArrayList(QmrTypeSelectionEnum.AET_PROGRAMMES);
		List<EmploymentStatusEnum> employmentStatusEnum = null;
		List<LearnerStatusEnum> learnerStatusEnumList = QmrGenericService.instance().prepLearnerStatusEnumBasedOnIndicator(2);
	...
	/**
	 * Generates List<haj.com.entity.QmrAETProgrammeData> for a quarter provided. 
	 * 
	 * @param qmrFinYears
	 * @return List<QmrAETProgrammeData>
	 * @throws Exception
	 */
	public List<QmrAETProgrammeData> generateQuaterData(QmrFinYears qmrFinYears) throws Exception {
		
		List<QmrScriptFiveBean> results = null;
		List<QmrAETProgrammeData> transformedResults = null;
		List<QmrAETProgrammeData> returnResults = new ArrayList<>();
		
		results = runAETProgrammeEnteredForQuarterNotSaved(qmrFinYears);
		if (!results.isEmpty()) {
		...
		results = runAETProgrammeCompletedForQuarterNotSaved(qmrFinYears);
		if (!results.isEmpty()) {
	 ...
	 * @throws Exception
	 */
	private List<QmrAETProgrammeData> populateDataIntoReportingForm(List<QmrScriptFiveBean> extractedResults, QmrFinYears qmrFinYears, QmrEnteredCompletedEnum qmrEnteredCompletedEnum, EmploymentStatusEnum employmentStatusEnum) throws Exception {
		List<QmrAETProgrammeData> results = new ArrayList<>();
		for (QmrScriptFiveBean bean : extractedResults) {
			QmrAETProgrammeData newEntry = new QmrAETProgrammeData();
	...
	public Integer countTotalEntries(Long qmrFinYearId, EmploymentStatusEnum employedUnEmployed, QmrEnteredCompletedEnum qmrEnteredCompletedEnum) throws Exception {
		return dao.countTotalEntries(qmrFinYearId, employedUnEmployed, qmrEnteredCompletedEnum);
	}
}