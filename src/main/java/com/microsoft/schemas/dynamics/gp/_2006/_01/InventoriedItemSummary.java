...
/**
 * <p>Java class for InventoriedItemSummary complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="InventoriedItemSummary"&gt;
 *   &lt;complexContent&gt;
 *     &lt;extension base="{http://schemas.microsoft.com/dynamics/gp/2006/01}ItemSummaryBase"&gt;
 *       &lt;sequence&gt;
 *         &lt;element name="Type" type="{http://schemas.microsoft.com/dynamics/gp/2006/01}InventoriedItemType"/&gt;
...
@XmlType(name = "InventoriedItemSummary", propOrder = {
    "type",
    "isDiscontinued"
})
public class InventoriedItemSummary
    extends ItemSummaryBase
{

    @XmlElement(name = "Type", required = true)
    @XmlSchemaType(name = "string")
    protected InventoriedItemType type;
     ...
     *     
     */
    public InventoriedItemType getType() {
        return type;
    }
     ...
     *     
     */
    public void setType(InventoriedItemType value) {
        this.type = value;
    }
