...
/**
 * <p>Java class for ReceivablesDocumentScope.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="ReceivablesDocumentScope"&gt;
 ...
 * 
 */
@XmlType(name = "ReceivablesDocumentScope")
@XmlEnum
public enum ReceivablesDocumentScope {
    ...
    ReceivablesDocumentScope(String v) {
        value = v;
    }
    ...
    public static ReceivablesDocumentScope fromValue(String v) {
        for (ReceivablesDocumentScope c: ReceivablesDocumentScope.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
